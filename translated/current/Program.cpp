...
auto read_source_(string const path_) -> Source_Text const *_Nonnull;
auto run_unit_tests_(system__console__Console *_Nonnull const console_) -> void;
Source_Text *_Nonnull Source_Text__new__3(Source_Text *_Nonnull self, string const package_, string const path_, string const text_);
inline Source_Text *_Nonnull new_Source_Text(string const package_, string const path_, string const text_);
auto line_starts_(string const text_) -> system__collections__List<i32> const *_Nonnull;
...
Text_Line *_Nonnull Text_Line__new__3(Text_Line *_Nonnull self, Source_Text const *_Nonnull const source_, i32 const start_, i32 const length_);
inline Text_Line *_Nonnull new_Text_Line(Source_Text const *_Nonnull const source_, i32 const start_, i32 const length_);
Text_Line *_Nonnull Text_Line__new__spanning__3(Text_Line *_Nonnull self, Source_Text const *_Nonnull const source_, i32 const start_, i32 const end_);
...
Text_Lines *_Nonnull Text_Lines__new__2(Text_Lines *_Nonnull self, Source_Text const *_Nonnull const source_, system__collections__List<i32> const *_Nonnull const start_of_line_);
...
Text_Position *_Nonnull Text_Position__new__3(Text_Position *_Nonnull self, i32 const character_offset_, i32 const line_, i32 const column_);
...
Text_Span *_Nonnull Text_Span__new__2(Text_Span *_Nonnull self, i32 const start_, i32 const length_);
inline Text_Span *_Nonnull new_Text_Span(i32 const start_, i32 const length_);
auto format_error_(string const message_) -> string;
...
auto error_(Source_File_Builder *_Nonnull const file_, string const message_) -> void;
auto begin_line_(Source_File_Builder *_Nonnull const file_, string const value_) -> void;
auto write_(Source_File_Builder *_Nonnull const file_, string const value_) -> void;
auto end_line_(Source_File_Builder *_Nonnull const file_, string const value_) -> void;
auto write_line_(Source_File_Builder *_Nonnull const file_, string const value_) -> void;
...
auto to_string_(Source_File_Builder *_Nonnull const file_) -> string;
Compilation_Unit *_Nonnull Compilation_Unit__new__2(Compilation_Unit *_Nonnull self, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_);
...
Package *_Nonnull Package__new__4(Package *_Nonnull self, Package_Name const *_Nonnull const name_, system__collections__List<Package_Reference> const *_Nonnull const references_, system__collections__List<Compilation_Unit const *_Nonnull> const *_Nonnull const compilation_units_, Symbol const *_Nonnull const symbol_);
...
Package_Reference Package_Reference__new__1(Package const *_Nonnull const package_);
inline Package_Reference new_Package_Reference(Package const *_Nonnull const package_);
Package_Reference Package_Reference__new__2(string const name_, Package const *_Nonnull const package_);
inline Package_Reference new_Package_Reference(string const name_, Package const *_Nonnull const package_);
...
auto build_primitive_symbol_(string const name_, Name const *_Nonnull const namespace_) -> Symbol const *_Nonnull;
...
auto build_class_symbol_(Name const *_Nonnull const namespace_, string const class_name_) -> Symbol const *_Nonnull;
auto build_class_symbol_(Name const *_Nonnull const namespace_, string const class_name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_) -> Symbol const *_Nonnull;
auto build_generic_class_symbol_(Name const *_Nonnull const namespace_, string const class_name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_) -> Symbol const *_Nonnull;
auto build_constructor_symbol_(string const name_) -> Symbol const *_Nonnull;
...
Semantic_Node *_Nonnull Semantic_Node__new__token__1(Semantic_Node *_Nonnull self, Syntax_Node const *_Nonnull const syntax_);
inline Semantic_Node *_Nonnull new_Semantic_Node__token(Syntax_Node const *_Nonnull const syntax_);
Semantic_Node *_Nonnull Semantic_Node__new__concrete__2(Semantic_Node *_Nonnull self, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_);
...
Semantic_Node *_Nonnull Semantic_Node__new__of_type__3(Semantic_Node *_Nonnull self, Type const *_Nonnull const of_type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_);
...
Semantic_Node *_Nonnull Semantic_Node__new__declares_type__3(Semantic_Node *_Nonnull self, Type const *_Nonnull const type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_);
...
Semantic_Node *_Nonnull Semantic_Node__new__referencing_type__3(Semantic_Node *_Nonnull self, Type const *_Nonnull const type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_);
...
auto get_text_(Semantic_Node const *_Nonnull const node_) -> string;
...
auto node_argument_count_(Semantic_Node const *_Nonnull const node_) -> i32;
...
Compilation_Unit_Parser *_Nonnull Compilation_Unit_Parser__new__1(Compilation_Unit_Parser *_Nonnull self, Token_Stream *_Nonnull const token_stream_);
...
Syntax_Node *_Nonnull Syntax_Node__new__4(Syntax_Node *_Nonnull self, i32 const type_, Source_Text const *_Nonnull const source_, u32 const start_, u32 const length_);
...
Syntax_Node *_Nonnull Syntax_Node__new__5(Syntax_Node *_Nonnull self, i32 const type_, bit const isMissing_, Source_Text const *_Nonnull const source_, u32 const start_, u32 const length_);
...
Syntax_Node *_Nonnull Syntax_Node__new__2(Syntax_Node *_Nonnull self, i32 const type_, Syntax_Node const *_Nonnull const child_);
inline Syntax_Node *_Nonnull new_Syntax_Node(i32 const type_, Syntax_Node const *_Nonnull const child_);
Syntax_Node *_Nonnull Syntax_Node__new__2(Syntax_Node *_Nonnull self, i32 const type_, system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const children_);
...
Syntax_Node *_Nonnull Syntax_Node__new__missing__3(Syntax_Node *_Nonnull self, i32 const type_, Source_Text const *_Nonnull const source_, u32 const start_);
...
Syntax_Node *_Nonnull Syntax_Node__new__skipped__1(Syntax_Node *_Nonnull self, Syntax_Node const *_Nonnull const skipped_node_);
inline Syntax_Node *_Nonnull new_Syntax_Node__skipped(Syntax_Node const *_Nonnull const skipped_node_);
Syntax_Node *_Nonnull Syntax_Node__new__skipped__1(Syntax_Node *_Nonnull self, system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const skipped_nodes_);
...
auto get_text_(Syntax_Node const *_Nonnull const syntax_) -> string;
...
Token_Stream *_Nonnull Token_Stream__new__1(Token_Stream *_Nonnull self, Source_Text const *_Nonnull const source_);
...
auto is_identifier_char_(code_point const c_) -> bit;
auto is_number_char_(code_point const c_) -> bit;
Diagnostic *_Nonnull Diagnostic__new__5(Diagnostic *_Nonnull self, i32 const level_, i32 const phase_, Source_Text const *_Nonnull const source_, Text_Span const *_Nonnull const span_, string const message_);
inline Diagnostic *_Nonnull new_Diagnostic(i32 const level_, i32 const phase_, Source_Text const *_Nonnull const source_, Text_Span const *_Nonnull const span_, string const message_);
Emitter *_Nonnull Emitter__new__2(Emitter *_Nonnull self, Package const *_Nonnull const package_, system__collections__List<Source_Text const *_Nonnull> const *_Nonnull const resources_);
...
auto emit_(Emitter *_Nonnull const emitter_) -> string;
auto mangle_name_(Name const *_Nonnull const name_) -> string;
auto mangle_function_name_(string const name_, i32 const parameter_count_) -> string;
auto mangle_field_name_(string const name_) -> string;
auto contains_multi_underscore_runs_(string const value_) -> bit;
auto append_fixing_underscores_(system__text__String_Builder *_Nonnull const builder_, string const value_) -> void;
auto convert_primitive_type_name_(Type const *_Nonnull const type_) -> string;
...
auto convert_reference_type_(bit const mutable_binding_, Type const *_Nonnull type_, bit const nullable_) -> string;
auto convert_type_(bit const mutable_binding_, Type const *_Nonnull type_, bit const optional_) -> string;
auto convert_type_(bit const mutable_binding_, Semantic_Node const *_Nonnull const type_node_) -> string;
auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, string const self_type_, bit const is_main_function_) -> string;
auto convert_method_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, string const self_type_) -> string;
auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, bit const is_main_function_) -> string;
auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_) -> string;
...
auto emit_constructor_body_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const block_, string const self_type_, bit const is_value_type_) -> void;
auto emit_member_declaration_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const member_, string const class_name_, bit const is_value_type_) -> void;
auto emit_default_constructor_(Emitter *_Nonnull const emitter_, string const type_name_, bit const is_value_type_) -> void;
...
Name *_Nonnull Name__new__global_namespace__1(Name *_Nonnull self, Package_Name const *_Nonnull const package_);
inline Name *_Nonnull new_Name__global_namespace(Package_Name const *_Nonnull const package_);
Name *_Nonnull Name__new__3(Name *_Nonnull self, Name const *_Nonnull const qualifier_, i32 const kind_, string const name_);
inline Name *_Nonnull new_Name(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_);
Name *_Nonnull Name__new__4(Name *_Nonnull self, Name const *_Nonnull const qualifier_, i32 const kind_, string const name_, bit const is_special_);
inline Name *_Nonnull new_Name(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_, bit const is_special_);
Name *_Nonnull Name__new__special__3(Name *_Nonnull self, Name const *_Nonnull const qualifier_, i32 const kind_, string const name_);
inline Name *_Nonnull new_Name__special(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_);
Name *_Nonnull Name__new__4(Name *_Nonnull self, Package_Name const *_Nullable const package_, i32 const kind_, system__collections__List<string> const *_Nonnull const segments_, bit const is_special_);
inline Name *_Nonnull new_Name(Package_Name const *_Nullable const package_, i32 const kind_, system__collections__List<string> const *_Nonnull const segments_, bit const is_special_);
auto unqualified_name_(Name const *_Nonnull const name_) -> string;
auto full_name_(Name const *_Nonnull const name_) -> string;
...
Package_Name *_Nonnull Package_Name__new__1(Package_Name *_Nonnull self, string const name_);
inline Package_Name *_Nonnull new_Package_Name(string const name_);
auto full_name_(Package_Name const *_Nonnull const package_name_) -> string;
Symbol *_Nonnull Symbol__new__identifier__1(Symbol *_Nonnull self, string const name_);
inline Symbol *_Nonnull new_Symbol__identifier(string const name_);
Symbol *_Nonnull Symbol__new__identifier__2(Symbol *_Nonnull self, string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_);
inline Symbol *_Nonnull new_Symbol__identifier(string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_);
Symbol *_Nonnull Symbol__new__identifier__2(Symbol *_Nonnull self, string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
inline Symbol *_Nonnull new_Symbol__identifier(string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
Symbol *_Nonnull Symbol__new__constructor__2(Symbol *_Nonnull self, string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_);
inline Symbol *_Nonnull new_Symbol__constructor(string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_);
Symbol *_Nonnull Symbol__new__package__2(Symbol *_Nonnull self, string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
inline Symbol *_Nonnull new_Symbol__package(string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
Symbol *_Nonnull Symbol__new__declaring__3(Symbol *_Nonnull self, Type const *_Nonnull const declares_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
...
Symbol *_Nonnull Symbol__new__of_type__4(Symbol *_Nonnull self, string const name_, Type const *_Nonnull const of_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
inline Symbol *_Nonnull new_Symbol__of_type(string const name_, Type const *_Nonnull const of_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_);
auto get_child_(Symbol const *_Nonnull const symbol_, string const name_, i32 const kind_) -> Symbol const *_Nullable;
auto unit_test_Symbol_() -> void;
auto Package_symbol_children_can_be_found_by_name_and_kind_() -> void;
Type *_Nonnull Type__new__3(Type *_Nonnull self, i32 const kind_, Name const *_Nonnull const name_, bit const is_mutable_);
inline Type *_Nonnull new_Type(i32 const kind_, Name const *_Nonnull const name_, bit const is_mutable_);
Type *_Nonnull Type__new__parameter__1(Type *_Nonnull self, string const name_);
inline Type *_Nonnull new_Type__parameter(string const name_);
Type *_Nonnull Type__new__4(Type *_Nonnull self, i32 const kind_, Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_, bit const is_mutable_);
...
Type *_Nonnull Type__new__primitive__1(Type *_Nonnull self, Name const *_Nonnull const name_);
inline Type *_Nonnull new_Type__primitive(Name const *_Nonnull const name_);
Type *_Nonnull Type__new__primitive__2(Type *_Nonnull self, Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_);
...
Type *_Nonnull Type__new__namespace__1(Type *_Nonnull self, Name const *_Nonnull const name_);
inline Type *_Nonnull new_Type__namespace(Name const *_Nonnull const name_);
Type *_Nonnull Type__new__generic__2(Type *_Nonnull self, Type const *_Nonnull const definition_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_arguments_);
...
Type *_Nonnull Type__new__6(Type *_Nonnull self, i32 const kind_, Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_, bit const is_primitive_, bit const is_potentially_mutable_, bit const is_mutable_);
...
Name_Subtable *_Nonnull Name_Subtable__new__global_namespace__1(Name_Subtable *_Nonnull self, Name_Table const *_Nonnull const name_table_);
inline Name_Subtable *_Nonnull new_Name_Subtable__global_namespace(Name_Table const *_Nonnull const name_table_);
Name_Subtable *_Nonnull Name_Subtable__new__global_namespace__2(Name_Subtable *_Nonnull self, Name_Table const *_Nonnull const name_table_, Package_Name const *_Nonnull const package_name_);
...
Name_Subtable *_Nonnull Name_Subtable__new__3(Name_Subtable *_Nonnull self, Name_Subtable const *_Nonnull const parent_, Name const *_Nonnull const name_, Type const *_Nonnull const type_);
...
auto find_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable;
auto find_special_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable;
auto find_(Name_Subtable const *_Nonnull const scope_, string const name_, bit const is_special_) -> Name_Subtable *_Nullable;
auto lookup_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable;
auto lookup_special_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable;
auto lookup_(Name_Subtable const *_Nonnull const scope_, string const name_, bit const is_special_) -> Name_Subtable *_Nullable;
...
struct Emitter
{
	...
	string main_function_name_;
	string main_function_return_type_;
...
struct Name
{
	...
	i32 kind_;
	system__collections__List<string> const *_Nonnull segments_;
	bit is_special_;
};
...
i32 const SkippedTokens_ = i32__op__negate(i32(1));
...
auto write_(system__console__Console *_Nonnull const console_, system__collections__List<Diagnostic const *_Nonnull> const *_Nonnull const diagnostics_) -> void
{
	for (Diagnostic const *_Nonnull const diagnostic_ : *(diagnostics_))
	{
		...
		{
			severity_ = string("Informational");
		}
		else if (cond(equal_op(diagnostic_->level_, Warning_)))
		{
			severity_ = string("Warning");
		}
		else
		{
			severity_ = string("Error");
		}

		console_->WriteLine_(diagnostic_->source_->path_->op__add(string(":"))->op__add(position_->line_)->op__add(string(":"))->op__add(position_->column_)->op__add(string(" "))->op__add(severity_)->op__add(string(":")));
		console_->WriteLine_(string("  ").op__add(diagnostic_->message_));
	}
}
...
auto has_errors_(system__collections__List<Diagnostic const *_Nonnull> const *_Nonnull const diagnostics_) -> bit
{
	for (Diagnostic const *_Nonnull const diagnostic_ : *(diagnostics_))
	{
		if (cond(diagnostic_->level_->op__greater_than_or_equal(CompilationError_)))
		{
			return bit__true;
		}
	}
...
auto main_(system__console__Console *_Nonnull const console_, system__console__Arguments const *_Nonnull const args_) -> i32
{
	if (cond(bit__op(bit__arg(equal_op(args_->op__magnitude(), i32(1))) && bit__arg(equal_op(args_->op__Element(i32(0)), string("--unit-test"))))))
	{
		run_unit_tests_(console_);
		return i32(0);
	}

	system__collections__List<string> *_Nonnull const sourceFilePaths_ = new_system__collections__List<string>();
	system__collections__List<string> *_Nonnull const resourceFilePaths_ = new_system__collections__List<string>();
	string outputFilePath_ = string("");
	bit verbose_ = bit__false;
	i32 argType_ = i32(0);
	for (string const arg_ : *(args_))
	{
		if (cond(equal_op(argType_, i32(0))))
		{
			if (cond(equal_op(arg_, string("-r"))))
			{
				argType_ = i32(1);
			}
			else if (cond(equal_op(arg_, string("-o"))))
			{
				argType_ = i32(2);
			}
			else if (cond(bit__op(bit__arg(equal_op(arg_, string("-v"))) || bit__arg(equal_op(arg_, string("--verbose"))))))
			{
				verbose_ = bit__true;
			}
			else
	...
	if (cond(bit__op(bit__arg(equal_op(sourceFilePaths_->op__magnitude(), i32(0))) || bit__arg(equal_op(outputFilePath_, string(""))))))
	{
	...
	if (cond(resourceFilePaths_->op__magnitude()->op__greater_than(i32(0))))
	{
		if (cond(verbose_))
		{
		...
		for (string const resourceFilePath_ : *(resourceFilePaths_))
		{
			if (cond(verbose_))
			{
				console_->WriteLine_(string("  ").op__add(resourceFilePath_));
			}
	...
	for (string const sourceFilePath_ : *(sourceFilePaths_))
	{
		if (cond(verbose_))
		{
			console_->WriteLine_(string("  ").op__add(sourceFilePath_));
		}
	...
	string const translated_ = emit_(emitter_);
	if (cond(verbose_))
	{
	...
	i32 index_ = outputDirPath_.LastIndexOf_(code_point('/'));
	if (cond(not_equal_op(index_, i32__op__negate(i32(1)))))
	{
		outputDirPath_ = outputDirPath_.Substring_(i32(0), index_.op__add(i32(1)));
	}

	index_ = outputDirPath_.LastIndexOf_(code_point('\\'));
	if (cond(not_equal_op(index_, i32__op__negate(i32(1)))))
	{
		outputDirPath_ = outputDirPath_.Substring_(i32(0), index_.op__add(i32(1)));
	}
	...
	system__io__File_Writer *_Nonnull resourceFile_ = new_system__io__File_Writer(outputDirPath_.op__add(string("RuntimeLibrary.hpp")));
	resourceFile_->Write_(resource_manager_->GetString_(string("RuntimeLibrary.hpp")));
	resourceFile_->Close_();
	resourceFile_ = new_system__io__File_Writer(outputDirPath_.op__add(string("RuntimeLibrary.cpp")));
...
auto read_source_(string const path_) -> Source_Text const *_Nonnull
{
	...
	file_->Close_();
	return new_Source_Text(string("<default>"), path_, contents_);
}

auto run_unit_tests_(system__console__Console *_Nonnull const console_) -> void
{
	console_->WriteLine_(string("Running Unit Tests..."));
...
Source_Text *_Nonnull Source_Text__new__3(Source_Text *_Nonnull self, string const package_, string const path_, string const text_)
{
	...
	self->path_ = path_;
	string name_ = path_;
	i32 index_ = name_.LastIndexOf_(code_point('/'));
	if (cond(not_equal_op(index_, i32__op__negate(i32(1)))))
	{
		name_ = name_.Substring_(index_.op__add(i32(1)));
	}

	index_ = name_.LastIndexOf_(code_point('\\'));
	if (cond(not_equal_op(index_, i32__op__negate(i32(1)))))
	{
		name_ = name_.Substring_(index_.op__add(i32(1)));
	}
...
inline Source_Text *_Nonnull new_Source_Text(string const package_, string const path_, string const text_)
{
	return Source_Text__new__3(new Source_Text(), package_, path_, text_);
}
...
auto line_starts_(string const text_) -> system__collections__List<i32> const *_Nonnull
{
	...
	i32 position_ = i32(0);
	while (cond(i32__op__less_than(position_, length_)))
	{
		code_point const c_ = text_.op__Element(position_);
		position_.op__add_assign(i32(1));
		if (cond(bit__op(bit__arg(code_point__op__greater_than(c_, code_point('\r'))) && bit__arg(code_point__op__less_than_or_equal(c_, code_point('\x7F'))))))
		{
			continue;
		}

		if (cond(equal_op(c_, code_point('\r'))))
		{
			if (cond(bit__op(bit__arg(i32__op__less_than(position_, length_)) && bit__arg(equal_op(text_.op__Element(position_), code_point('\n'))))))
			{
				position_.op__add_assign(i32(1));
			}
		}
		else if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(c_, code_point('\n'))) || bit__arg(equal_op(c_, code_point('\x0B'))))) || bit__arg(equal_op(c_, code_point('\f'))))) || bit__arg(equal_op(c_, code_point('\x85'))))))
		{
		}
		else
		{
...
auto position_of_start_(Source_Text const *_Nonnull const source_, Text_Span const *_Nonnull const span_) -> Text_Position const *_Nonnull
{
	...
	i32 column_ = char_offset_.op__subtract(line_start_)->op__add(i32(1));
	i32 i_ = line_start_;
	while (cond(i32__op__less_than(i_, char_offset_)))
	{
		if (cond(equal_op(source_->text_.op__Element(i_), code_point('\t'))))
		{
			column_.op__add_assign(i32(3));
		}

		i_.op__add_assign(i32(1));
	}
...
inline Text_Line *_Nonnull new_Text_Line(Source_Text const *_Nonnull const source_, i32 const start_, i32 const length_)
{
	return Text_Line__new__3(new Text_Line(), source_, start_, length_);
}
...
Text_Line *_Nonnull Text_Line__new__spanning__3(Text_Line *_Nonnull self, Source_Text const *_Nonnull const source_, i32 const start_, i32 const end_)
{
	self->source_ = source_;
	self->start_ = start_;
	self->byte_length_ = end_.op__subtract(start_);
	return self;
}

inline Text_Line *_Nonnull new_Text_Line__spanning(Source_Text const *_Nonnull const source_, i32 const start_, i32 const end_)
{
	return Text_Line__new__spanning__3(new Text_Line(), source_, start_, end_);
}
...
inline Text_Lines *_Nonnull new_Text_Lines(Source_Text const *_Nonnull const source_, system__collections__List<i32> const *_Nonnull const start_of_line_)
{
	return Text_Lines__new__2(new Text_Lines(), source_, start_of_line_);
}

auto line_count_(Text_Lines const *_Nonnull const lines_) -> i32
{
	return lines_->start_of_line_->op__magnitude();
}

auto get_line_(Text_Lines const *_Nonnull const lines_, i32 const line_number_) -> Text_Line const *_Nonnull
{
	assert_(i32__op__greater_than(line_number_, i32(0)), string("line ").op__add(line_number_));
	assert_(i32__op__less_than_or_equal(line_number_, line_count_(lines_)), string("line ").op__add(line_number_));
	i32 const line_index_ = line_number_.op__subtract(i32(1));
	i32 const line_start_ = lines_->start_of_line_->op__Element(line_index_);
	if (cond(equal_op(line_index_, line_count_(lines_)->op__subtract(i32(1)))))
	{
		return new_Text_Line__spanning(lines_->source_, line_start_, source_byte_length_(lines_->source_));
	}

	i32 const line_end_ = lines_->start_of_line_->op__Element(line_index_.op__add(i32(1)));
	return new_Text_Line__spanning(lines_->source_, line_start_, line_end_);
}

auto line_containing_offset_(Text_Lines const *_Nonnull const lines_, i32 const character_offset_) -> i32
{
	assert_(i32__op__greater_than_or_equal(character_offset_, i32(0)), string("offset ").op__add(character_offset_));
	assert_(i32__op__less_than_or_equal(character_offset_, source_byte_length_(lines_->source_)), string("offset ").op__add(character_offset_)->op__add(string(" source length "))->op__add(source_byte_length_(lines_->source_)));
	i32 left_ = i32(0);
	i32 right_ = line_count_(lines_)->op__subtract(i32(1));
	while (cond(i32__op__less_than_or_equal(left_, right_)))
	{
		i32 const mid_ = left_.op__add(right_.op__subtract(left_)->op__divide(i32(2)));
		i32 const mid_line_start_ = lines_->start_of_line_->op__Element(mid_);
		if (cond(i32__op__less_than(mid_line_start_, character_offset_)))
		{
			left_ = mid_.op__add(i32(1));
		}
		else if (cond(i32__op__greater_than(mid_line_start_, character_offset_)))
		{
			right_ = mid_.op__subtract(i32(1));
		}
		else
		{
			return mid_.op__add(i32(1));
		}
	}
...
inline Text_Position *_Nonnull new_Text_Position(i32 const character_offset_, i32 const line_, i32 const column_)
{
	return Text_Position__new__3(new Text_Position(), character_offset_, line_, column_);
}
...
auto Text_Position_retains_given_offeset_line_and_column_() -> void
{
	...
	assert_(equal_op(position_->character_offset_, i32(23)), string(""));
	assert_(equal_op(position_->line_, i32(2)), string(""));
	assert_(equal_op(position_->column_, i32(5)), string(""));
}
...
inline Text_Span *_Nonnull new_Text_Span(i32 const start_, i32 const length_)
{
	return Text_Span__new__2(new Text_Span(), start_, length_);
}

auto format_error_(string const message_) -> string
{
	return string("<$ ").op__add(message_)->op__add(string(" $>"));
}
...
Source_File_Builder *_Nonnull Source_File_Builder__new__0(Source_File_Builder *_Nonnull self)
{
	...
	self->firstElement_ = bit__true;
	self->afterBlock_ = bit__true;
	return self;
}
...
auto begin_line_(Source_File_Builder *_Nonnull const file_, string const value_) -> void
{
	...
	file_->firstElement_ = file_->afterBlock_ = bit__false;
}
...
{
	file_->code_->AppendLine_();
	file_->firstElement_ = bit__true;
	file_->afterBlock_ = bit__false;
}

auto element_separator_line_(Source_File_Builder *_Nonnull const file_) -> void
{
	if (cond(bit__op__not(file_->firstElement_)))
	{
		file_->code_->AppendLine_();
		file_->firstElement_ = bit__true;
		file_->afterBlock_ = bit__false;
...
auto begin_block_(Source_File_Builder *_Nonnull const file_) -> void
{
	write_line_(file_, string("{"));
	file_->indent_->Append_(string("\t"));
	file_->firstElement_ = file_->afterBlock_ = bit__false;
}
...
inline Compilation_Unit *_Nonnull new_Compilation_Unit(Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_)
{
	return Compilation_Unit__new__2(new Compilation_Unit(), syntax_, declarations_);
}
...
inline Package *_Nonnull new_Package(Package_Name const *_Nonnull const name_, system__collections__List<Package_Reference> const *_Nonnull const references_, system__collections__List<Compilation_Unit const *_Nonnull> const *_Nonnull const compilation_units_, Symbol const *_Nonnull const symbol_)
{
	return Package__new__4(new Package(), name_, references_, compilation_units_, symbol_);
}
...
inline Package_Reference new_Package_Reference(Package const *_Nonnull const package_)
{
	return Package_Reference__new__1(package_);
}
...
inline Package_Reference new_Package_Reference(string const name_, Package const *_Nonnull const package_)
{
	return Package_Reference__new__2(name_, package_);
}

auto build_primitives_package_() -> Package const *_Nonnull
{
	Package_Name const *_Nonnull const name_ = new_Package_Name(string("$primitives"));
	...
	assert_(primitive_symbols_->op__magnitude()->op__greater_than(i32(0)), string("|primitive_symbols|=").op__add(primitive_symbols_->op__magnitude()));
	Symbol const *_Nonnull const package_symbol_ = new_Symbol__package(name_->unqualified_, primitive_symbols_);
	assert_(package_symbol_->children_->op__magnitude()->op__greater_than(i32(0)), string("|package_symbol.children|=").op__add(package_symbol_->children_->op__magnitude()));
...
auto build_primitive_symbols_(Package_Name const *_Nonnull const package_name_) -> system__collections__List<Symbol const *_Nonnull> *_Nonnull
{
	...
	symbols_->add_(build_primitive_symbol_(string("void"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("never"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("bool"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("code_point"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("string"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("int8"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("int16"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("int"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("int64"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("int128"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("byte"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("uint16"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("uint"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("uint64"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("uint128"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("float32"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("float"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("float128"), global_namespace_));
	...
	symbols_->add_(build_primitive_symbol_(string("decimal32"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("decimal"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("decimal128"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("size"), global_namespace_));
	symbols_->add_(build_primitive_symbol_(string("offset"), global_namespace_));
	return symbols_;
}

auto build_adamant_language_namespace_symbol_(Name const *_Nonnull const global_namespace_) -> Symbol const *_Nonnull
{
	Name const *_Nonnull const adamant_namespace_ = new_Name(global_namespace_, NamespaceName_, string("adamant"));
	Name const *_Nonnull const language_namespace_ = new_Name(adamant_namespace_, NamespaceName_, string("language"));
...
auto build_optional_type_symbol_(Name const *_Nonnull const language_namespace_) -> Symbol const *_Nonnull
{
	Name const *_Nonnull const optional_name_ = new_Name(language_namespace_, TypeName_, string("optional"));
	...
	type_parameters_->add_(new_Type(TypeParameterType_, new_Name(optional_name_, TypeParameterName_, string("T")), bit__true));
...
auto Package_name_is_dollar_primitives_() -> void
{
	...
	assert_(equal_op(name_->unqualified_, string("$primitives")), string(""));
}

auto Package_has_no_references_or_compilation_units_() -> void
{
	Package const *_Nonnull const package_ = build_primitives_package_();
	assert_(equal_op(package_->references_->op__magnitude(), i32(0)), string(""));
	assert_(equal_op(package_->compilation_units_->op__magnitude(), i32(0)), string(""));
}
...
auto Package_symbol_has_package_name_() -> void
{
	...
	assert_(equal_op(symbol_->kind_, PackageSymbol_), string(""));
	assert_(equal_op(symbol_->name_, package_->name_->unqualified_), string(""));
}

auto Package_symbol_has_children_() -> void
{
	Package const *_Nonnull const package_ = build_primitives_package_();
	assert_(package_->symbol_->children_->op__magnitude()->op__greater_than(i32(0)), string(""));
}

auto Package_contains_the_string_type_() -> void
{
	Package const *_Nonnull const package_ = build_primitives_package_();
	Symbol const *_Nonnull const string_symbol_ = get_child_(package_->symbol_, string("string"), IdentifierSymbol_);
	assert_(not_equal_op(string_symbol_, none), string(""));
}

auto Package_contains_optional_type_() -> void
{
	Package const *_Nonnull const package_ = build_primitives_package_();
	Symbol const *_Nullable const adamant_symbol_ = get_child_(package_->symbol_, string("adamant"), IdentifierSymbol_);
	assert_(not_equal_op(adamant_symbol_, none), string(""));
	Symbol const *_Nullable const langauge_symbol_ = get_child_(adamant_symbol_, string("language"), IdentifierSymbol_);
	assert_(not_equal_op(langauge_symbol_, none), string(""));
	Symbol const *_Nullable const optional_symbol_ = get_child_(langauge_symbol_, string("optional"), IdentifierSymbol_);
	assert_(not_equal_op(optional_symbol_, none), string(""));
}

auto build_runtime_library_package_() -> Package const *_Nonnull
{
	Package_Name const *_Nonnull const name_ = new_Package_Name(string("$runtime"));
	system__collections__List<Package_Reference> const *_Nonnull const references_ = new_system__collections__List<Package_Reference>();
	system__collections__List<Compilation_Unit const *_Nonnull> const *_Nonnull const compilation_units_ = new_system__collections__List<Compilation_Unit const *_Nonnull>();
	system__collections__List<Symbol const *_Nonnull> *_Nonnull const symbols_ = build_runtime_library_symbols_(name_);
	assert_(symbols_->op__magnitude()->op__greater_than(i32(0)), string("|symbols|=").op__add(symbols_->op__magnitude()));
...
auto build_runtime_library_symbols_(Package_Name const *_Nonnull const package_name_) -> system__collections__List<Symbol const *_Nonnull> *_Nonnull
{
	Name const *_Nonnull const global_namespace_ = new_Name__global_namespace(package_name_);
	system__collections__List<Symbol const *_Nonnull> *_Nonnull const symbols_ = new_system__collections__List<Symbol const *_Nonnull>();
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, FunctionName_, string("NOT_IMPLEMENTED"))));
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, FunctionName_, string("UNREACHABLE"))));
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, FunctionName_, string("assert"))));
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, FunctionName_, string("debug_write"))));
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, FunctionName_, string("debug_write_line"))));
	symbols_->add_(build_function_symbol_(new_Name(global_namespace_, VariableName_, string("resource_manager"))));
	Name const *_Nonnull const system_namespace_ = new_Name(global_namespace_, NamespaceName_, string("system"));
	...
	Name const *_Nonnull const collections_namespace_ = new_Name(system_namespace_, NamespaceName_, string("collections"));
	...
	list_type_parameters_->add_(new_Type__parameter(string("T")));
	collections_symbols_->add_(build_generic_class_symbol_(collections_namespace_, string("List"), list_type_parameters_));
	system_symbols_->add_(build_namespace_symbol_(collections_namespace_, collections_symbols_));
	Name const *_Nonnull const console_namespace_ = new_Name(system_namespace_, NamespaceName_, string("console"));
	...
	console_symbols_->add_(build_class_symbol_(console_namespace_, string("Console")));
	console_symbols_->add_(build_class_symbol_(console_namespace_, string("Arguments")));
	system_symbols_->add_(build_namespace_symbol_(console_namespace_, console_symbols_));
	Name const *_Nonnull const io_namespace_ = new_Name(system_namespace_, NamespaceName_, string("io"));
	...
	io_symbols_->add_(build_class_symbol_(io_namespace_, string("File_Reader")));
	io_symbols_->add_(build_class_symbol_(io_namespace_, string("File_Writer")));
	system_symbols_->add_(build_namespace_symbol_(io_namespace_, io_symbols_));
	Name const *_Nonnull const text_namespace_ = new_Name(system_namespace_, NamespaceName_, string("text"));
	...
	string_builder_symbols_->add_(build_constructor_symbol_(string("with_capacity")));
	text_symbols_->add_(build_class_symbol_(text_namespace_, string("String_Builder"), string_builder_symbols_));
...
auto build_function_symbol_(Name const *_Nonnull const name_) -> Symbol const *_Nonnull
{
	Type const *_Nonnull const type_ = new_Type(FunctionType_, name_, bit__false);
...
auto build_class_symbol_(Name const *_Nonnull const namespace_, string const class_name_) -> Symbol const *_Nonnull
{
	Type const *_Nonnull const type_ = new_Type(ReferenceType_, new_Name(namespace_, TypeName_, class_name_), bit__true);
	system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_ = new_system__collections__List<Semantic_Node const *_Nonnull>();
	system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_ = new_system__collections__List<Symbol const *_Nonnull>();
	return new_Symbol__declaring(type_, declarations_, children_);
}
...
auto build_generic_class_symbol_(Name const *_Nonnull const namespace_, string const class_name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_) -> Symbol const *_Nonnull
{
	Type const *_Nonnull const type_ = new_Type(ReferenceType_, new_Name(namespace_, TypeName_, class_name_), type_parameters_, bit__true);
	system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_ = new_system__collections__List<Semantic_Node const *_Nonnull>();
	system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_ = new_system__collections__List<Symbol const *_Nonnull>();
	return new_Symbol__declaring(type_, declarations_, children_);
}
...
auto build_constructor_symbol_(string const name_) -> Symbol const *_Nonnull
{
	string const constructor_name_ = string("new_").op__add(name_);
	system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_ = new_system__collections__List<Semantic_Node const *_Nonnull>();
...
auto Runtime_Library_Package_contains_system_package_() -> void
{
	...
	assert_(not_equal_op(get_child_(package_->symbol_, string("system"), IdentifierSymbol_), none), string(""));
}

auto System_namespace_contains_console_namespace_() -> void
{
	Package const *_Nonnull const package_ = build_runtime_library_package_();
	Symbol const *_Nonnull const system_namespace_ = get_child_(package_->symbol_, string("system"), IdentifierSymbol_);
	assert_(not_equal_op(get_child_(system_namespace_, string("console"), IdentifierSymbol_), none), string(""));
}
...
auto Console_namespace_contains_Console_class_() -> void
{
	Package const *_Nonnull const package_ = build_runtime_library_package_();
	Symbol const *_Nonnull const system_namespace_ = get_child_(package_->symbol_, string("system"), IdentifierSymbol_);
	Symbol const *_Nonnull const console_namespace_ = get_child_(system_namespace_, string("console"), IdentifierSymbol_);
	assert_(not_equal_op(get_child_(console_namespace_, string("Console"), IdentifierSymbol_), none), string(""));
}
...
auto System_namespace_contains_collections_namespace_() -> void
{
	Package const *_Nonnull const package_ = build_runtime_library_package_();
	Symbol const *_Nonnull const system_namespace_ = get_child_(package_->symbol_, string("system"), IdentifierSymbol_);
	assert_(not_equal_op(get_child_(system_namespace_, string("collections"), IdentifierSymbol_), none), string(""));
}
...
auto Collections_namespace_contains_List_class_() -> void
{
	Package const *_Nonnull const package_ = build_runtime_library_package_();
	Symbol const *_Nonnull const system_namespace_ = get_child_(package_->symbol_, string("system"), IdentifierSymbol_);
	Symbol const *_Nonnull const console_namespace_ = get_child_(system_namespace_, string("collections"), IdentifierSymbol_);
	assert_(not_equal_op(get_child_(console_namespace_, string("List"), IdentifierSymbol_), none), string(""));
}

auto analyze_semantics_(Syntax_Node const *_Nonnull const package_syntax_) -> Package const *_Nonnull
{
	assert_(equal_op(package_syntax_->kind_, PackageNode_), string("package_syntax.kind=").op__add(package_syntax_->kind_));
	Package_Name const *_Nonnull const name_ = new_Package_Name(string("default"));
...
Semantic_Node *_Nonnull Semantic_Node__new__token__1(Semantic_Node *_Nonnull self, Syntax_Node const *_Nonnull const syntax_)
{
	assert_(not_equal_op(syntax_, none), string(""));
	self->syntax_ = syntax_;
...
inline Semantic_Node *_Nonnull new_Semantic_Node__token(Syntax_Node const *_Nonnull const syntax_)
{
	return Semantic_Node__new__token__1(new Semantic_Node(), syntax_);
}
...
inline Semantic_Node *_Nonnull new_Semantic_Node__concrete(Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	return Semantic_Node__new__concrete__2(new Semantic_Node(), syntax_, children_);
}

Semantic_Node *_Nonnull Semantic_Node__new__of_type__3(Semantic_Node *_Nonnull self, Type const *_Nonnull const of_type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	assert_(not_equal_op(of_type_, none), string(""));
	assert_(not_equal_op(syntax_, none), string(""));
	self->syntax_ = syntax_;
	self->kind_ = syntax_->kind_;
	self->is_missing_ = syntax_->is_missing_;
...
inline Semantic_Node *_Nonnull new_Semantic_Node__of_type(Type const *_Nonnull const of_type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	return Semantic_Node__new__of_type__3(new Semantic_Node(), of_type_, syntax_, children_);
}

Semantic_Node *_Nonnull Semantic_Node__new__declares_type__3(Semantic_Node *_Nonnull self, Type const *_Nonnull const type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	assert_(not_equal_op(type_, none), string(""));
	assert_(not_equal_op(syntax_, none), string(""));
	self->syntax_ = syntax_;
	self->kind_ = syntax_->kind_;
	self->is_missing_ = syntax_->is_missing_;
...
inline Semantic_Node *_Nonnull new_Semantic_Node__declares_type(Type const *_Nonnull const type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	return Semantic_Node__new__declares_type__3(new Semantic_Node(), type_, syntax_, children_);
}
...
inline Semantic_Node *_Nonnull new_Semantic_Node__referencing_type(Type const *_Nonnull const type_, Syntax_Node const *_Nonnull const syntax_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const children_)
{
	return Semantic_Node__new__referencing_type__3(new Semantic_Node(), type_, syntax_, children_);
}
...
auto node_members_(Semantic_Node const *_Nonnull const node_) -> system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull
{
	...
	for (Semantic_Node const *_Nonnull const child_ : *(node_->children_))
	{
		if (cond(bit__op(bit__arg(bit__op(bit__arg(equal_op(child_->kind_, ConstructorDeclaration_)) || bit__arg(equal_op(child_->kind_, FieldDeclaration_)))) || bit__arg(equal_op(child_->kind_, MethodDeclaration_)))))
		{
...
auto node_statements_(Semantic_Node const *_Nonnull const node_) -> system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull
{
	...
	for (Semantic_Node const *_Nonnull const child_ : *(node_->children_))
	{
		if (cond(bit__op(bit__arg(not_equal_op(child_->kind_, LeftBrace_)) && bit__arg(not_equal_op(child_->kind_, RightBrace_)))))
		{
...
auto node_parameters_(Semantic_Node const *_Nonnull const node_) -> system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull
{
	...
	for (Semantic_Node const *_Nonnull const child_ : *(node_->children_))
	{
		if (cond(bit__op(bit__arg(equal_op(child_->kind_, Parameter_)) || bit__arg(equal_op(child_->kind_, SelfParameter_)))))
		{
...
auto node_argument_count_(Semantic_Node const *_Nonnull const node_) -> i32
{
	...
	for (Semantic_Node const *_Nonnull const child_ : *(node_->children_))
	{
		if (cond(bit__op(bit__arg(bit__op(bit__arg(equal_op(child_->kind_, LeftParen_)) || bit__arg(equal_op(child_->kind_, RightParen_)))) || bit__arg(equal_op(child_->kind_, Comma_)))))
		{
			continue;
		}

		count_.op__add_assign(i32(1));
	}
...
auto node_access_modifier_(Semantic_Node const *_Nonnull const node_) -> Semantic_Node const *_Nullable
{
	for (Semantic_Node const *_Nonnull const child_ : *(node_->children_))
	{
		if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(child_->kind_, PublicKeyword_)) || bit__arg(equal_op(child_->kind_, ProtectedKeyword_)))) || bit__arg(equal_op(child_->kind_, PrivateKeyword_)))) || bit__arg(equal_op(child_->kind_, InternalKeyword_)))))
		{
			return child_;
		}
	}
...
Semantic_Tree_Builder *_Nonnull Semantic_Tree_Builder__new__0(Semantic_Tree_Builder *_Nonnull self)
{
	Package_Name const *_Nonnull const primitives_package_ = new_Package_Name(string("$primitives"));
	Name const *_Nonnull const global_namespace_ = new_Name__global_namespace(primitives_package_);
	Name const *_Nonnull const adamant_namespace_ = new_Name(global_namespace_, NamespaceName_, string("adamant"));
	Name const *_Nonnull const language_namespace_ = new_Name(adamant_namespace_, NamespaceName_, string("language"));
	self->optional_type_name_ = new_Name(language_namespace_, TypeName_, string("optional"));
	return self;
}
...
{
	assert_(equal_op(package_syntax_->kind_, PackageNode_), string("package_syntax.kind=").op__add(package_syntax_->kind_));
	assert_(not_equal_op(lookup_special_(name_table_->any_package_, string("string")), none), string("name_table.any_package.name=").op__add(full_name_(name_table_->any_package_->name_)));
...
auto build_compilation_unit_semantic_node_(Semantic_Tree_Builder const *_Nonnull const builder_, Syntax_Node const *_Nonnull const compilation_unit_syntax_, Name_Table const *_Nonnull const name_table_) -> Compilation_Unit const *_Nonnull
{
	assert_(equal_op(compilation_unit_syntax_->kind_, CompilationUnit_), string("compilation_unit_syntax.kind=").op__add(compilation_unit_syntax_->kind_));
...
{
	system__collections__List<Semantic_Node const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Semantic_Node const *_Nonnull>();
	if (cond(bit__op(bit__arg(equal_op(syntax_->kind_, FunctionDeclaration_)) || bit__arg(equal_op(syntax_->kind_, MethodDeclaration_)))))
	{
		...
		assert_(not_equal_op(function_scope_, none), string("get_text(function_name)=").op__add(get_text_(function_name_)));
		...
		Syntax_Node const *_Nonnull const return_type_ = syntax_->children_->op__Element(i32(4));
		children_->add_(build_type_name_semantic_node_(builder_, return_type_, name_table_, scope_));
		Type const *_Nonnull const function_type_ = new_Type(FunctionType_, function_scope_->name_, bit__false);
	...
	else if (cond(bit__op(bit__arg(equal_op(syntax_->kind_, ClassDeclaration_)) || bit__arg(equal_op(syntax_->kind_, StructDeclaration_)))))
	{
		...
		assert_(not_equal_op(type_scope_, none), string("get_text(type_name)=").op__add(get_text_(type_name_)));
	...
	else if (cond(equal_op(syntax_->kind_, ConstructorDeclaration_)))
	{
		...
		{
			full_name_ = string("new_").op__add(get_text_(constructor_name_));
		...
		assert_(not_equal_op(constructor_scope_, none), string("full_name=").op__add(full_name_));
		Syntax_Node const *_Nonnull const parameters_ = first_child_syntax_(syntax_, ParameterList_);
	...
	else if (cond(equal_op(syntax_->kind_, IdentifierName_)))
	{
		...
		if (cond(equal_op(name_scope_, none)))
		{
			...
			if (cond(bit__op__not(syntax_->is_missing_)))
			{
	...
	{
		Semantic_Node const *_Nonnull const lhs_ = build_semantic_node_(builder_, syntax_->children_->op__Element(i32(0)), name_table_, scope_);
		children_->add_(lhs_);
		Semantic_Node *_Nonnull rhs_;
		Syntax_Node const *_Nonnull const member_name_ = syntax_->children_->op__Element(i32(2));
	...
	{
		children_->add_(build_constructor_name_semantic_node_(builder_, syntax_->children_->op__Element(i32(1)), name_table_, scope_));
	...
	{
		Syntax_Node const *_Nonnull const binding_syntax_ = syntax_->children_->op__Element(i32(0));
		...
		Syntax_Node const *_Nonnull const type_syntax_ = syntax_->children_->op__Element(i32(3));
		...
		if (cond(equal_op(syntax_->children_->op__magnitude(), i32(6))))
		{
			Syntax_Node const *_Nonnull const initalizer_ = syntax_->children_->op__Element(i32(5));
			children_->add_(build_semantic_node_(builder_, initalizer_, name_table_, scope_));
		}

		return new_Semantic_Node__concrete(syntax_, children_);
	}
	else if (cond(bit__op(bit__arg(equal_op(syntax_->kind_, TrueLiteralExpression_)) || bit__arg(equal_op(syntax_->kind_, FalseLiteralExpression_)))))
	{
		return new_Semantic_Node__of_type(lookup_special_(scope_, string("bool"))->type_, syntax_, children_);
	}
	else if (cond(equal_op(syntax_->kind_, StringLiteralExpression_)))
	{
		return new_Semantic_Node__of_type(lookup_special_(scope_, string("string"))->type_, syntax_, children_);
	}
	else if (cond(equal_op(syntax_->kind_, CodePointLiteralExpression_)))
	{
		return new_Semantic_Node__of_type(lookup_special_(scope_, string("code_point"))->type_, syntax_, children_);
	}
	else if (cond(equal_op(syntax_->kind_, NumericLiteralExpression_)))
	{
		return new_Semantic_Node__of_type(lookup_special_(scope_, string("int"))->type_, syntax_, children_);
	}
	else if (cond(equal_op(syntax_->children_->op__magnitude(), i32(0))))
	{
...
auto build_parameters_semantic_node_(Semantic_Tree_Builder const *_Nonnull const builder_, Syntax_Node const *_Nonnull const parameters_syntax_, Name_Table const *_Nonnull const name_table_, Name_Subtable const *_Nonnull const scope_) -> Semantic_Node *_Nonnull
{
	assert_(equal_op(parameters_syntax_->kind_, ParameterList_), string("parameters_syntax.kind=").op__add(parameters_syntax_->kind_));
	...
	for (Syntax_Node const *_Nonnull const parameter_ : *(parameters_(parameters_syntax_)))
	{
		...
		if (cond(equal_op(parameter_->kind_, Parameter_)))
		{
			...
			children_->add_(new_Semantic_Node__token(identifier_));
			Syntax_Node const *_Nonnull const type_syntax_ = parameter_->children_->op__Element(parameter_->children_->op__magnitude()->op__subtract(i32(1)));
			Semantic_Node const *_Nonnull const type_node_ = build_type_name_semantic_node_(builder_, type_syntax_, name_table_, scope_);
		...
		{
			NOT_IMPLEMENTED_(string("parameter.kind=").op__add(parameter_->kind_));
		}
	}
...
auto build_type_name_semantic_node_(Semantic_Tree_Builder const *_Nonnull const builder_, Syntax_Node const *_Nonnull const syntax_, Name_Table const *_Nonnull const name_table_, Name_Subtable const *_Nonnull const scope_) -> Semantic_Node *_Nonnull
{
	...
	{
		string const primitive_name_ = get_text_(syntax_->children_->op__Element(i32(0)));
		Name_Subtable const *_Nullable const primitive_entry_ = lookup_special_(scope_, primitive_name_);
		assert_(not_equal_op(primitive_entry_, none), string("No entry for primitive `").op__add(primitive_name_)->op__add(string("`")));
	...
	else if (cond(equal_op(syntax_->kind_, IdentifierName_)))
	{
		...
		string const name_ = get_text_(syntax_);
	...
	{
		Syntax_Node const *_Nonnull const qualifier_syntax_ = syntax_->children_->op__Element(i32(0));
		...
		Syntax_Node const *_Nonnull const qualified_syntax_ = syntax_->children_->op__Element(i32(2));
	...
	{
		Semantic_Node *_Nonnull const inner_type_ = build_type_name_semantic_node_(builder_, syntax_->children_->op__Element(i32(1)), name_table_, scope_);
	...
	{
		Semantic_Node *_Nonnull const inner_type_ = build_type_name_semantic_node_(builder_, syntax_->children_->op__Element(i32(0)), name_table_, scope_);
		children_->add_(inner_type_);
		if (cond(equal_op(inner_type_->referenced_type_, none)))
		{
			add_could_not_determine_type_error_(inner_type_);
	...
	else if (cond(equal_op(syntax_->kind_, OptionalType_)))
	{
		...
		assert_(not_equal_op(optional_type_scope_, none), string(""));
	...
	{
		i32 const place_ = syntax_->start_;
		NOT_IMPLEMENTED_(string("syntax.kind=").op__add(syntax_->kind_)->op__add(string(" at "))->op__add(place_));
	}
}
...
auto build_type_arguments_semantic_node_(Semantic_Tree_Builder const *_Nonnull const builder_, Syntax_Node const *_Nonnull const syntax_, Name_Table const *_Nonnull const name_table_, Name_Subtable const *_Nonnull const scope_, system__collections__List<Semantic_Node const *_Nonnull> *_Nonnull const children_) -> system__collections__List<Type const *_Nonnull> const *_Nonnull
{
	...
	assert_(equal_op(syntax_->kind_, GenericName_), string("syntax.kind==").op__add(syntax_->kind_));
	bit in_type_arguments_ = bit__false;
...
auto build_constructor_name_semantic_node_(Semantic_Tree_Builder const *_Nonnull const builder_, Syntax_Node const *_Nonnull const syntax_, Name_Table const *_Nonnull const name_table_, Name_Subtable const *_Nonnull const scope_) -> Semantic_Node const *_Nonnull
{
	if (cond(bit__op(bit__arg(equal_op(syntax_->kind_, QualifiedName_)) && bit__arg(equal_op(syntax_->children_->op__Element(i32(2))->kind_, IdentifierName_)))))
	{
		system__collections__List<Semantic_Node const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Semantic_Node const *_Nonnull>();
		Semantic_Node const *_Nonnull const type_node_ = build_type_name_semantic_node_(builder_, syntax_->children_->op__Element(i32(0)), name_table_, scope_);
		children_->add_(type_node_);
		Syntax_Node const *_Nonnull const qualifier_ = syntax_->children_->op__Element(i32(0));
		Syntax_Node const *_Nonnull const name_ = syntax_->children_->op__Element(i32(2));
		string const constructor_name_ = string("new_").op__add(get_text_(name_));
		Type const *_Nonnull const referenced_type_ = type_node_->referenced_type_;
		assert_(not_equal_op(referenced_type_, none), string("no referenced type for `").op__add(get_text_(type_node_))->op__add(string("`")));
...
auto add_resolution_error_(Semantic_Node *_Nonnull const node_) -> void
{
	add_diagnostic_(node_, new_Diagnostic(FatalCompilationError_, Analysis_, node_->source_, get_text_span_(node_), string("Could not resolve name `").op__add(get_text_(node_))->op__add(string("`"))));
}

auto add_resolution_error_(Semantic_Node *_Nonnull const node_, Semantic_Node const *_Nonnull const qualifier_) -> void
{
	add_diagnostic_(node_, new_Diagnostic(FatalCompilationError_, Analysis_, node_->source_, get_text_span_(node_), string("Could not resolve name `").op__add(get_text_(node_))->op__add(string("` because qualifier `"))->op__add(get_text_(qualifier_))->op__add(string("` could not be resolved."))));
}

auto add_could_not_determine_type_error_(Semantic_Node *_Nonnull const node_) -> void
{
	add_diagnostic_(node_, new_Diagnostic(FatalCompilationError_, Analysis_, node_->source_, get_text_span_(node_), string("Could not determine type for `").op__add(get_text_(node_))->op__add(string("`"))));
}
...
inline Compilation_Unit_Parser *_Nonnull new_Compilation_Unit_Parser(Token_Stream *_Nonnull const token_stream_)
{
	return Compilation_Unit_Parser__new__1(new Compilation_Unit_Parser(), token_stream_);
}
...
auto expect_token_(Compilation_Unit_Parser *_Nonnull const parser_, i32 const tokenType_) -> Syntax_Node const *_Nonnull
{
	...
	if (cond(bit__op(bit__arg(equal_op(parser_->token_, none)) || bit__arg(not_equal_op(parser_->token_->kind_, tokenType_)))))
	{
...
auto parse_type_name_(Compilation_Unit_Parser *_Nonnull const parser_) -> Syntax_Node const *_Nonnull
{
	if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(parser_->token_->kind_, CodePoint_)) || bit__arg(equal_op(parser_->token_->kind_, String_)))) || bit__arg(equal_op(parser_->token_->kind_, Int_)))) || bit__arg(equal_op(parser_->token_->kind_, Bool_)))) || bit__arg(equal_op(parser_->token_->kind_, Void_)))) || bit__arg(equal_op(parser_->token_->kind_, UnsignedInt_)))))
	{
...
auto parse_expression_(Compilation_Unit_Parser *_Nonnull const parser_, i32 const minPrecedence_) -> Syntax_Node const *_Nonnull
{
	...
	for (;;)
	{
		...
		bit suffixOperator_ = bit__false;
		i32 expressionType_;
		if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(parser_->token_->kind_, Equals_)) || bit__arg(equal_op(parser_->token_->kind_, PlusEquals_)))) || bit__arg(equal_op(parser_->token_->kind_, MinusEquals_)))) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(1))))))
		{
			precedence_ = i32(1);
			leftAssociative_ = bit__false;
			children_->add_(accept_token_(parser_));
			expressionType_ = AssignmentExpression_;
		}
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, OrKeyword_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(2))))))
		{
			precedence_ = i32(2);
			leftAssociative_ = bit__true;
			children_->add_(expect_token_(parser_, OrKeyword_));
			expressionType_ = OrExpression_;
		}
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, AndKeyword_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(3))))))
		{
			precedence_ = i32(3);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, EqualsEquals_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(4))))))
		{
			precedence_ = i32(4);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, EqualsSlashEquals_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(4))))))
		{
			precedence_ = i32(4);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(parser_->token_->kind_, LessThan_)) || bit__arg(equal_op(parser_->token_->kind_, LessThanEquals_)))) || bit__arg(equal_op(parser_->token_->kind_, GreaterThan_)))) || bit__arg(equal_op(parser_->token_->kind_, GreaterThanEquals_)))) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(5))))))
		{
			precedence_ = i32(5);
			leftAssociative_ = bit__true;
			children_->add_(accept_token_(parser_));
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Plus_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(6))))))
		{
			precedence_ = i32(6);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Minus_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(6))))))
		{
			precedence_ = i32(6);
			leftAssociative_ = bit__true;
			children_->add_(expect_token_(parser_, Minus_));
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Asterisk_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(7))))))
		{
			precedence_ = i32(7);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Slash_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(7))))))
		{
			precedence_ = i32(7);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Percent_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(7))))))
		{
			precedence_ = i32(7);
			leftAssociative_ = bit__true;
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, LeftParen_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(9))))))
		{
			precedence_ = i32(9);
			leftAssociative_ = bit__true;
			suffixOperator_ = bit__true;
			children_->add_(parse_call_arguments_(parser_));
			expressionType_ = InvocationExpression_;
		}
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, Dot_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(9))))))
		{
			precedence_ = i32(9);
			leftAssociative_ = bit__true;
			children_->add_(expect_token_(parser_, Dot_));
		...
		else if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, LeftBracket_)) && bit__arg(i32__op__less_than_or_equal(minPrecedence_, i32(9))))))
		{
			precedence_ = i32(9);
			leftAssociative_ = bit__true;
			suffixOperator_ = bit__true;
		...
		if (cond(bit__op__not(suffixOperator_)))
		{
			if (cond(leftAssociative_))
			{
				precedence_.op__add_assign(i32(1));
			}
...
auto parse_statement_(Compilation_Unit_Parser *_Nonnull const parser_) -> Syntax_Node const *_Nonnull
{
	...
	if (cond(equal_op(parser_->token_->kind_, ForKeyword_)))
	{
		...
		children_->add_(parse_variable_declaration_(parser_, bit__false));
	...
	if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, VarKeyword_)) || bit__arg(equal_op(parser_->token_->kind_, LetKeyword_)))))
	{
		children_->add_(parse_variable_declaration_(parser_, bit__true));
		children_->add_(expect_token_(parser_, Semicolon_));
...
{
	system__collections__List<Syntax_Node const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Syntax_Node const *_Nonnull>();
	if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, LetKeyword_)) && bit__arg(not_equal_op(parser_->token_->kind_, VarKeyword_)))))
	{
	...
	if (cond(bit__op(bit__arg(allowInitializer_) && bit__arg(equal_op(parser_->token_->kind_, Equals_)))))
	{
...
auto parse_block_(Compilation_Unit_Parser *_Nonnull const parser_) -> Syntax_Node const *_Nonnull
{
	...
	while (cond(bit__op(bit__arg(not_equal_op(parser_->token_->kind_, RightBrace_)) && bit__arg(not_equal_op(parser_->token_->kind_, EndOfFileToken_)))))
	{
		...
		if (cond(equal_op(parser_->token_, startToken_)))
		{
			...
			while (cond(bit__op(bit__arg(bit__op(bit__arg(not_equal_op(parser_->token_->kind_, LeftBrace_)) && bit__arg(not_equal_op(parser_->token_->kind_, RightBrace_)))) && bit__arg(not_equal_op(parser_->token_->kind_, EndOfFileToken_)))))
			{
...
auto parse_parameter_list_(Compilation_Unit_Parser *_Nonnull const parser_) -> Syntax_Node const *_Nonnull
{
	...
	if (cond(not_equal_op(parser_->token_->kind_, RightParen_)))
	{
		for (;;)
		{
			...
			if (cond(bit__op(bit__arg(equal_op(parser_->token_->kind_, MutableKeyword_)) || bit__arg(equal_op(parser_->token_->kind_, SelfKeyword_)))))
			{
				if (cond(equal_op(parser_->token_->kind_, MutableKeyword_)))
				{
...
{
	system__collections__List<Syntax_Node const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Syntax_Node const *_Nonnull>();
	if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(parser_->token_->kind_, PublicKeyword_)) || bit__arg(equal_op(parser_->token_->kind_, ProtectedKeyword_)))) || bit__arg(equal_op(parser_->token_->kind_, InternalKeyword_)))) || bit__arg(equal_op(parser_->token_->kind_, PrivateKeyword_)))))
	{
		children_->add_(accept_token_(parser_));
	}
	else
...
{
	system__collections__List<Syntax_Node const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Syntax_Node const *_Nonnull>();
	while (cond(bit__op(bit__arg(not_equal_op(parser_->token_, none)) && bit__arg(not_equal_op(parser_->token_->kind_, EndOfFileToken_)))))
	{
		Syntax_Node const *_Nonnull const startToken_ = parser_->token_;
...
inline Syntax_Node *_Nonnull new_Syntax_Node(i32 const type_, Source_Text const *_Nonnull const source_, u32 const start_, u32 const length_)
{
	return Syntax_Node__new__4(new Syntax_Node(), type_, source_, start_, length_);
}
...
inline Syntax_Node *_Nonnull new_Syntax_Node(i32 const type_, bit const isMissing_, Source_Text const *_Nonnull const source_, u32 const start_, u32 const length_)
{
	return Syntax_Node__new__5(new Syntax_Node(), type_, isMissing_, source_, start_, length_);
}
...
inline Syntax_Node *_Nonnull new_Syntax_Node(i32 const type_, Syntax_Node const *_Nonnull const child_)
{
	return Syntax_Node__new__2(new Syntax_Node(), type_, child_);
}
...
Syntax_Node *_Nonnull Syntax_Node__new__2(Syntax_Node *_Nonnull self, i32 const type_, system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const children_)
{
	self->kind_ = type_;
	self->is_missing_ = bit__false;
	self->source_ = children_->op__Element(i32(0))->source_;
	self->start_ = children_->op__Element(i32(0))->start_;
	Syntax_Node const *_Nonnull const lastChild_ = children_->op__Element(children_->op__magnitude()->op__subtract(i32(1)));
	self->byte_length_ = lastChild_->start_.op__subtract(self->start_)->op__add(lastChild_->byte_length_);
	self->children_ = children_;
	self->node_diagnostics_ = new_system__collections__List<Diagnostic const *_Nonnull>();
	return self;
}
...
inline Syntax_Node *_Nonnull new_Syntax_Node(i32 const type_, system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const children_)
{
	return Syntax_Node__new__2(new Syntax_Node(), type_, children_);
}

Syntax_Node *_Nonnull Syntax_Node__new__missing__3(Syntax_Node *_Nonnull self, i32 const type_, Source_Text const *_Nonnull const source_, u32 const start_)
{
	self->kind_ = type_;
	self->is_missing_ = bit__true;
	self->source_ = source_;
	self->start_ = start_;
	...
	self->node_diagnostics_->add_(new_Diagnostic(CompilationError_, Parsing_, source_, span_, string("Missing token of type ").op__add(type_)));
	return self;
}

inline Syntax_Node *_Nonnull new_Syntax_Node__missing(i32 const type_, Source_Text const *_Nonnull const source_, u32 const start_)
{
	return Syntax_Node__new__missing__3(new Syntax_Node(), type_, source_, start_);
}
...
Syntax_Node *_Nonnull Syntax_Node__new__skipped__1(Syntax_Node *_Nonnull self, Syntax_Node const *_Nonnull const skipped_node_)
{
	...
	self->node_diagnostics_->add_(new_Diagnostic(CompilationError_, Parsing_, skipped_node_->source_, span_, string("Skipped unexpected token of type ").op__add(skipped_node_->kind_)));
	return self;
}

inline Syntax_Node *_Nonnull new_Syntax_Node__skipped(Syntax_Node const *_Nonnull const skipped_node_)
{
	return Syntax_Node__new__skipped__1(new Syntax_Node(), skipped_node_);
}
...
Syntax_Node *_Nonnull Syntax_Node__new__skipped__1(Syntax_Node *_Nonnull self, system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const skipped_nodes_)
{
	self->kind_ = SkippedTokens_;
	self->is_missing_ = bit__false;
	self->source_ = skipped_nodes_->op__Element(i32(0))->source_;
	self->start_ = skipped_nodes_->op__Element(i32(0))->start_;
	Syntax_Node const *_Nonnull const lastChild_ = skipped_nodes_->op__Element(skipped_nodes_->op__magnitude()->op__subtract(i32(1)));
	self->byte_length_ = lastChild_->start_.op__subtract(self->start_)->op__add(lastChild_->byte_length_);
	self->children_ = new_system__collections__List<Syntax_Node const *_Nonnull>();
	self->node_diagnostics_ = new_system__collections__List<Diagnostic const *_Nonnull>();
	Text_Span const *_Nonnull const span_ = new_Text_Span(self->start_, self->byte_length_);
	self->node_diagnostics_->add_(new_Diagnostic(CompilationError_, Parsing_, self->source_, span_, string("Skipped ").op__add(skipped_nodes_->op__magnitude())->op__add(string(" unexpected token(s)"))));
	return self;
}

inline Syntax_Node *_Nonnull new_Syntax_Node__skipped(system__collections__List<Syntax_Node const *_Nonnull> const *_Nonnull const skipped_nodes_)
{
	return Syntax_Node__new__skipped__1(new Syntax_Node(), skipped_nodes_);
}
...
auto access_modifier_(Syntax_Node const *_Nonnull const syntax_) -> Syntax_Node const *_Nullable
{
	for (Syntax_Node const *_Nonnull const child_ : *(syntax_->children_))
	{
		if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(child_->kind_, PublicKeyword_)) || bit__arg(equal_op(child_->kind_, ProtectedKeyword_)))) || bit__arg(equal_op(child_->kind_, InternalKeyword_)))) || bit__arg(equal_op(child_->kind_, PrivateKeyword_)))))
		{
			return child_;
		}
	}
...
Token_Stream *_Nonnull Token_Stream__new__1(Token_Stream *_Nonnull self, Source_Text const *_Nonnull const source_)
{
	...
	self->end_of_file_ = bit__false;
	return self;
}

inline Token_Stream *_Nonnull new_Token_Stream(Source_Text const *_Nonnull const source_)
{
	return Token_Stream__new__1(new Token_Stream(), source_);
}

auto next_token_(Token_Stream *_Nonnull const tokens_) -> Syntax_Node const *_Nullable
{
	if (cond(u32__op__greater_than_or_equal(tokens_->position_, source_byte_length_(tokens_->source_))))
	{
		return end_of_file_token_(tokens_);
	}

	u32 end_ = i32__op__negate(i32(1));
	while (cond(u32__op__less_than(tokens_->position_, source_byte_length_(tokens_->source_))))
	{
		code_point const curChar_ = tokens_->source_->text_.op__Element(tokens_->position_);
		if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(curChar_, code_point(' '))) || bit__arg(equal_op(curChar_, code_point('\t'))))) || bit__arg(equal_op(curChar_, code_point('\n'))))) || bit__arg(equal_op(curChar_, code_point('\r'))))))
		{
			tokens_->position_.op__add_assign(i32(1));
			continue;
		}
		else if (cond(equal_op(curChar_, code_point('{'))))
		{
		...
		{
			if (cond(bit__op(bit__arg(tokens_->position_.op__add(i32(1))->op__less_than(source_byte_length_(tokens_->source_))) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_.op__add(i32(1))), code_point('='))))))
			{
				return new_operator_token_(tokens_, EqualsEquals_, i32(2));
			}

			if (cond(bit__op(bit__arg(bit__op(bit__arg(tokens_->position_.op__add(i32(2))->op__less_than(source_byte_length_(tokens_->source_))) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_.op__add(i32(1))), code_point('/'))))) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_.op__add(i32(2))), code_point('='))))))
			{
		...
		else if (cond(equal_op(curChar_, code_point('/'))))
		{
			if (cond(bit__op(bit__arg(tokens_->position_.op__add(i32(1))->op__less_than(source_byte_length_(tokens_->source_))) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_.op__add(i32(1))), code_point('/'))))))
			{
				while (cond(bit__op(bit__arg(bit__op(bit__arg(u32__op__less_than(tokens_->position_, source_byte_length_(tokens_->source_))) && bit__arg(not_equal_op(tokens_->source_->text_.op__Element(tokens_->position_), code_point('\r'))))) && bit__arg(not_equal_op(tokens_->source_->text_.op__Element(tokens_->position_), code_point('\n'))))))
				{
					tokens_->position_.op__add_assign(i32(1));
				}
			...
			if (cond(bit__op(bit__arg(tokens_->position_.op__add(i32(1))->op__less_than(source_byte_length_(tokens_->source_))) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_.op__add(i32(1))), code_point('*'))))))
			{
				tokens_->position_.op__add_assign(i32(2));
				bit lastCharStar_ = bit__false;
				while (cond(bit__op(bit__arg(u32__op__less_than(tokens_->position_, source_byte_length_(tokens_->source_))) && bit__arg(bit__op__not(bit__op(bit__arg(lastCharStar_) && bit__arg(equal_op(tokens_->source_->text_.op__Element(tokens_->position_), code_point('/')))))))))
				{
					lastCharStar_ = equal_op(tokens_->source_->text_.op__Element(tokens_->position_), code_point('*'));
					tokens_->position_.op__add_assign(i32(1));
				}
		...
		{
			end_ = tokens_->position_.op__add(i32(1));
			bit escaped_ = bit__false;
			while (cond(bit__op(bit__arg(u32__op__less_than(end_, source_byte_length_(tokens_->source_))) && bit__arg(bit__op(bit__arg(not_equal_op(tokens_->source_->text_.op__Element(end_), code_point('"'))) || bit__arg(escaped_))))))
			{
				escaped_ = bit__op(bit__arg(equal_op(tokens_->source_->text_.op__Element(end_), code_point('\\'))) && bit__arg(bit__op__not(escaped_)));
				end_.op__add_assign(i32(1));
			}
		...
		else
		{
			...
			{
				end_ = tokens_->position_.op__add(i32(1));
				while (cond(is_identifier_char_(tokens_->source_->text_.op__Element(end_))))
				{
					end_.op__add_assign(i32(1));
				}
			...
			{
				end_ = tokens_->position_.op__add(i32(1));
				while (cond(is_number_char_(tokens_->source_->text_.op__Element(end_))))
				{
					end_.op__add_assign(i32(1));
				}
			...
			tokens_->diagnostics_->add_(new_Diagnostic(CompilationError_, Lexing_, tokens_->source_, diagnosticSpan_, string("Invalid character `").op__add(curChar_)->op__add(string("`"))));
...
auto end_of_file_token_(Token_Stream *_Nonnull const tokens_) -> Syntax_Node const *_Nullable
{
	...
	tokens_->end_of_file_ = bit__true;
	return new_token_(tokens_, EndOfFileToken_, tokens_->position_);
}

auto new_identifier_or_keyword_token_(Token_Stream *_Nonnull const tokens_, u32 const end_) -> Syntax_Node const *_Nonnull
{
	u32 const length_ = end_.op__subtract(tokens_->position_);
	string const value_ = tokens_->source_->text_.Substring_(tokens_->position_, length_);
	i32 type_;
	if (cond(equal_op(value_, string("new"))))
	{
		type_ = NewKeyword_;
	}
	else if (cond(equal_op(value_, string("not"))))
	{
		type_ = NotOperator_;
	}
	else if (cond(equal_op(value_, string("null"))))
	{
		type_ = NullReservedWord_;
	}
	else if (cond(equal_op(value_, string("self"))))
	{
		type_ = SelfKeyword_;
	}
	else if (cond(equal_op(value_, string("true"))))
	{
		type_ = TrueKeyword_;
	}
	else if (cond(equal_op(value_, string("false"))))
	{
		type_ = FalseKeyword_;
	}
	else if (cond(equal_op(value_, string("mut"))))
	{
		type_ = MutableKeyword_;
	}
	else if (cond(equal_op(value_, string("code_point"))))
	{
		type_ = CodePoint_;
	}
	else if (cond(equal_op(value_, string("string"))))
	{
		type_ = String_;
	}
	else if (cond(equal_op(value_, string("int"))))
	{
		type_ = Int_;
	}
	else if (cond(equal_op(value_, string("bool"))))
	{
		type_ = Bool_;
	}
	else if (cond(equal_op(value_, string("void"))))
	{
		type_ = Void_;
	}
	else if (cond(equal_op(value_, string("uint"))))
	{
		type_ = UnsignedInt_;
	}
	else if (cond(equal_op(value_, string("var"))))
	{
		type_ = VarKeyword_;
	}
	else if (cond(equal_op(value_, string("and"))))
	{
		type_ = AndKeyword_;
	}
	else if (cond(equal_op(value_, string("or"))))
	{
		type_ = OrKeyword_;
	}
	else if (cond(equal_op(value_, string("return"))))
	{
		type_ = ReturnKeyword_;
	}
	else if (cond(equal_op(value_, string("loop"))))
	{
		type_ = LoopKeyword_;
	}
	else if (cond(equal_op(value_, string("while"))))
	{
		type_ = WhileKeyword_;
	}
	else if (cond(equal_op(value_, string("for"))))
	{
		type_ = ForKeyword_;
	}
	else if (cond(equal_op(value_, string("let"))))
	{
		type_ = LetKeyword_;
	}
	else if (cond(equal_op(value_, string("in"))))
	{
		type_ = InKeyword_;
	}
	else if (cond(equal_op(value_, string("do"))))
	{
		type_ = DoKeyword_;
	}
	else if (cond(equal_op(value_, string("if"))))
	{
		type_ = IfKeyword_;
	}
	else if (cond(equal_op(value_, string("else"))))
	{
		type_ = ElseKeyword_;
	}
	else if (cond(equal_op(value_, string("break"))))
	{
		type_ = BreakKeyword_;
	}
	else if (cond(equal_op(value_, string("continue"))))
	{
		type_ = ContinueKeyword_;
	}
	else if (cond(equal_op(value_, string("private"))))
	{
		type_ = PrivateKeyword_;
	}
	else if (cond(equal_op(value_, string("protected"))))
	{
		type_ = ProtectedKeyword_;
	}
	else if (cond(equal_op(value_, string("public"))))
	{
		type_ = PublicKeyword_;
	}
	else if (cond(equal_op(value_, string("internal"))))
	{
		type_ = InternalKeyword_;
	}
	else if (cond(equal_op(value_, string("class"))))
	{
		type_ = ClassKeyword_;
	}
	else if (cond(equal_op(value_, string("enum"))))
	{
		type_ = EnumKeyword_;
	}
	else if (cond(equal_op(value_, string("struct"))))
	{
		type_ = StructKeyword_;
	}
	else if (cond(equal_op(value_, string("none"))))
	{
		type_ = NoneKeyword_;
	}
	else
	{
		type_ = Identifier_;
		if (cond(bit__op(bit__arg(value_.ByteLength_()->op__greater_than(i32(1))) && bit__arg(equal_op(value_.op__Element(value_.ByteLength_()->op__subtract(i32(1))), code_point('_'))))))
		{
			Text_Span const *_Nonnull diagnosticSpan_ = new_Text_Span(tokens_->position_, end_.op__subtract(tokens_->position_));
			tokens_->diagnostics_->add_(new_Diagnostic(CompilationError_, Lexing_, tokens_->source_, diagnosticSpan_, string("Identifiers ending with underscore are reserved `").op__add(value_)->op__add(string("`"))));
		}
	}
...
auto new_operator_token_(Token_Stream *_Nonnull const tokens_, i32 const type_) -> Syntax_Node const *_Nonnull
{
	return new_token_(tokens_, type_, tokens_->position_.op__add(i32(1)));
}

auto new_operator_token_(Token_Stream *_Nonnull const tokens_, i32 const type_, u32 const length_) -> Syntax_Node const *_Nonnull
{
	return new_token_(tokens_, type_, tokens_->position_.op__add(length_));
}

auto new_token_(Token_Stream *_Nonnull const tokens_, i32 const type_, u32 const end_) -> Syntax_Node const *_Nonnull
{
	Syntax_Node *_Nonnull const token_ = new_Syntax_Node(type_, tokens_->source_, tokens_->position_, end_.op__subtract(tokens_->position_));
...
auto is_identifier_char_(code_point const c_) -> bit
{
	return bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(code_point__op__greater_than_or_equal(c_, code_point('a'))) && bit__arg(code_point__op__less_than_or_equal(c_, code_point('z'))))) || bit__arg(bit__op(bit__arg(code_point__op__greater_than_or_equal(c_, code_point('A'))) && bit__arg(code_point__op__less_than_or_equal(c_, code_point('Z'))))))) || bit__arg(equal_op(c_, code_point('_'))));
}

auto is_number_char_(code_point const c_) -> bit
{
	return bit__op(bit__arg(code_point__op__greater_than_or_equal(c_, code_point('0'))) && bit__arg(code_point__op__less_than_or_equal(c_, code_point('9'))));
}
...
inline Diagnostic *_Nonnull new_Diagnostic(i32 const level_, i32 const phase_, Source_Text const *_Nonnull const source_, Text_Span const *_Nonnull const span_, string const message_)
{
	return Diagnostic__new__5(new Diagnostic(), level_, phase_, source_, span_, message_);
}
...
inline Emitter *_Nonnull new_Emitter(Package const *_Nonnull const package_, system__collections__List<Source_Text const *_Nonnull> const *_Nonnull const resources_)
{
	return Emitter__new__2(new Emitter(), package_, resources_);
}
...
auto emit_(Emitter *_Nonnull const emitter_) -> string
{
	...
	emitter_->main_function_return_type_ = string("");
	emitter_->main_function_accepts_console_ = bit__false;
	emitter_->main_function_accepts_args_ = bit__false;
	...
	i32 const total_size_ = byte_length_(emitter_->type_declarations_)->op__add(byte_length_(emitter_->function_declarations_))->op__add(byte_length_(emitter_->class_declarations_))->op__add(byte_length_(emitter_->global_definitions_))->op__add(byte_length_(emitter_->definitions_));
...
auto mangle_name_(Name const *_Nonnull const name_) -> string
{
	...
	bit first_segment_ = bit__true;
	for (string const segment_ : *(name_->segments_))
	{
		if (cond(first_segment_))
		{
			first_segment_ = bit__false;
		}
		else
		{
			builder_->Append_(string("__"));
		}

		if (cond(bit__op__not(contains_multi_underscore_runs_(segment_))))
		{
			builder_->Append_(segment_);
		}
		else
		{
			append_fixing_underscores_(builder_, segment_);
		}
	}
...
{
	system__text__String_Builder *_Nonnull const builder_ = new_system__text__String_Builder();
	if (cond(bit__op__not(contains_multi_underscore_runs_(name_))))
	{
		builder_->Append_(name_);
	}
	else
	{
		append_fixing_underscores_(builder_, name_);
	}

	builder_->Append_(string("__"));
	builder_->Append_(parameter_count_);
	return builder_->ToString_();
}
...
auto mangle_field_name_(string const name_) -> string
{
	if (cond(bit__op__not(contains_multi_underscore_runs_(name_))))
	{
		return name_.op__add(string("__"));
	}
	else
	{
		system__text__String_Builder *_Nonnull const builder_ = new_system__text__String_Builder();
...
{
	i32 i_ = i32(0);
	bit last_char_underscore_ = bit__false;
	while (cond(i32__op__less_than(i_, value_.ByteLength_())))
	{
		if (cond(equal_op(value_.op__Element(i_), code_point('_'))))
		{
			...
			last_char_underscore_ = bit__true;
		}
		else
		{
			last_char_underscore_ = bit__false;
		}
...
auto append_fixing_underscores_(system__text__String_Builder *_Nonnull const builder_, string const value_) -> void
{
	...
	while (cond(i32__op__less_than(i_, value_.ByteLength_())))
	{
		if (cond(equal_op(value_.op__Element(i_), code_point('_'))))
		{
			underscores_.op__add_assign(i32(1));
		}
		else if (cond(i32__op__greater_than(underscores_, i32(0))))
		{
			if (cond(i32__op__greater_than_or_equal(underscores_, i32(2))))
			{
		...
		builder_->Append_(new_string(value_.op__Element(i_), i32(1)));
		i_.op__add_assign(i32(1));
	}
}
...
auto convert_primitive_type_name_(Type const *_Nonnull const type_) -> string
{
	string const name_ = unqualified_name_(type_->name_);
	assert_(type_->is_primitive_, name_);
	if (cond(equal_op(name_, string("bool"))))
	{
		return string("bit");
	}
	else if (cond(equal_op(name_, string("int"))))
	{
		return string("i32");
	}
	else if (cond(equal_op(name_, string("uint"))))
	{
		return string("u32");
	}
	else
...
auto convert_type_name_(Type const *_Nonnull const type_) -> system__text__String_Builder *_Nonnull
{
	...
	if (cond(type_->type_parameters_->op__magnitude()->op__greater_than(i32(0))))
	{
		cpp_type_->Append_(string("<"));
		bit first_ = bit__true;
		for (Type const *_Nonnull const type_parameter_ : *(type_->type_parameters_))
		{
			...
			cpp_type_->Append_(convert_type_(bit__true, type_parameter_, bit__false));
		}
...
auto convert_reference_type_(bit const mutable_binding_, Type const *_Nonnull type_, bit const nullable_) -> string
{
	...
	if (cond(bit__op__not(type_->is_mutable_)))
	{
		cpp_type_->Append_(string(" const"));
	}

	cpp_type_->Append_(string(" *"));
	if (cond(nullable_))
	{
		cpp_type_->Append_(string("_Nullable"));
	}
	else
	{
		cpp_type_->Append_(string("_Nonnull"));
	}

	if (cond(bit__op__not(mutable_binding_)))
	{
		cpp_type_->Append_(string(" const"));
	}
...
{
	assert_(not_equal_op(type_, none), string(""));
	if (cond(bit__op(bit__arg(type_->is_primitive_) && bit__arg(equal_op(unqualified_name_(type_->name_), string("optional"))))))
	{
		Type const *_Nonnull const optional_type_ = type_->type_parameters_->op__Element(i32(0));
		if (cond(optional_type_->is_value_type_))
		{
			system__text__String_Builder *_Nonnull const cpp_type_ = new_system__text__String_Builder(string("p_optional<"));
			cpp_type_->Append_(convert_type_(bit__true, optional_type_, bit__true));
			cpp_type_->Append_(string(">"));
			if (cond(bit__op(bit__arg(bit__op__not(mutable_binding_)) && bit__arg(bit__op__not(type_->is_mutable_)))))
			{
				cpp_type_->Append_(string(" const"));
			}
		...
		{
			return convert_type_(mutable_binding_, optional_type_, bit__true);
		}
	}
	else
	{
...
{
	assert_(not_equal_op(type_node_->referenced_type_, none), get_text_(type_node_));
	return convert_type_(mutable_binding_, type_node_->referenced_type_, bit__false);
}

auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, string const self_type_, bit const is_main_function_) -> string
{
	assert_(equal_op(parameters_->kind_, ParameterList_), string("parameters.kind=").op__add(parameters_->kind_));
	system__text__String_Builder *_Nonnull const builder_ = new_system__text__String_Builder();
	builder_->Append_(string("("));
	if (cond(self_type_.ByteLength_()->op__greater_than(i32(0))))
	{
		builder_->Append_(self_type_);
		builder_->Append_(string(" self"));
	}
	...
	{
		if (cond(bit__op__not(first_parameter_)))
		{
			builder_->Append_(string(", "));
		}
		else
		{
			first_parameter_ = bit__false;
		}

		bit const mutable_binding_ = node_has_child_(parameter_, VarKeyword_);
		Semantic_Node const *_Nonnull const type_node_ = parameter_->children_->op__Element(parameter_->children_->op__magnitude()->op__subtract(i32(1)));
		builder_->Append_(convert_type_(mutable_binding_, type_node_));
		builder_->Append_(string(" "));
		builder_->Append_(mangle_field_name_(get_text_(first_child_(parameter_, Identifier_))));
		if (cond(is_main_function_))
		{
			string type_string_;
			if (cond(equal_op(type_node_->kind_, MutableType_)))
			{
				type_string_ = get_text_(type_node_->children_->op__Element(i32(0)));
			}
			else
			{
			...
			if (cond(equal_op(type_string_, string("system.console.Console"))))
			{
				emitter_->main_function_accepts_console_ = bit__true;
			}

			if (cond(equal_op(type_string_, string("system.console.Arguments"))))
			{
				emitter_->main_function_accepts_args_ = bit__true;
			}
		}
	}
...
auto convert_method_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, string const self_type_) -> string
{
	return convert_parameter_list_(emitter_, parameters_, self_type_, bit__false);
}

auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_, bit const is_main_function_) -> string
{
	return convert_parameter_list_(emitter_, parameters_, string(""), is_main_function_);
}

auto convert_parameter_list_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const parameters_) -> string
{
	return convert_parameter_list_(emitter_, parameters_, string(""), bit__false);
}
...
auto convert_expression_(Semantic_Node const *_Nonnull const syntax_, Source_File_Builder *_Nonnull const builder_) -> void
{
	...
	{
		string constructor_name_ = string("");
		Semantic_Node const *_Nonnull type_node_ = syntax_->children_->op__Element(i32(0));
		if (cond(equal_op(type_node_->kind_, QualifiedName_)))
		{
			Semantic_Node const *_Nonnull const name_node_ = type_node_->children_->op__Element(i32(1));
			if (cond(bit__op(bit__arg(equal_op(name_node_->kind_, IdentifierName_)) && bit__arg(equal_op(name_node_->referenced_type_, none)))))
			{
				constructor_name_ = string("__").op__add(get_text_(name_node_));
				type_node_ = type_node_->children_->op__Element(i32(0));
			}
		}

		Type const *_Nonnull const type_ = type_node_->referenced_type_;
		assert_(not_equal_op(type_, none), get_text_(type_node_));
		write_(builder_, string("new_"));
		write_(builder_, convert_type_name_(type_)->ToString_());
		write_(builder_, constructor_name_);
		Semantic_Node const *_Nonnull const argumentList_ = syntax_->children_->op__Element(i32(1));
		convert_expression_(argumentList_, builder_);
	}
	else if (cond(equal_op(syntax_->kind_, ArgumentList_)))
	{
		write_(builder_, string("("));
		bit first_expression_ = bit__true;
		for (Semantic_Node const *_Nonnull const arg_ : *(syntax_->children_))
		{
			if (cond(bit__op(bit__arg(bit__op(bit__arg(not_equal_op(arg_->kind_, LeftParen_)) && bit__arg(not_equal_op(arg_->kind_, RightParen_)))) && bit__arg(not_equal_op(arg_->kind_, Comma_)))))
			{
				if (cond(first_expression_))
				{
					first_expression_ = bit__false;
				}
				else
				{
					write_(builder_, string(", "));
	...
	{
		write_(builder_, string("bit__op__not("));
		convert_expression_(syntax_->children_->op__Element(i32(1)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, MagnitudeExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(1)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(1)), builder_);
		write_(builder_, string("op__magnitude()"));
	}
	...
	{
		write_(builder_, string("i32__op__negate("));
		convert_expression_(syntax_->children_->op__Element(i32(1)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, NoneLiteralExpression_)))
	{
		write_(builder_, string("none"));
	}
	else if (cond(equal_op(syntax_->kind_, SelfExpression_)))
	{
		write_(builder_, string("self"));
	}
	else if (cond(equal_op(syntax_->kind_, NumericLiteralExpression_)))
	{
		write_(builder_, string("i32(").op__add(get_text_(syntax_))->op__add(string(")")));
	}
	else if (cond(bit__op(bit__arg(equal_op(syntax_->kind_, TrueLiteralExpression_)) || bit__arg(equal_op(syntax_->kind_, FalseLiteralExpression_)))))
	{
		write_(builder_, string("bit__").op__add(get_text_(syntax_)));
	}
	else if (cond(equal_op(syntax_->kind_, CodePointLiteralExpression_)))
	{
		write_(builder_, string("code_point(").op__add(get_text_(syntax_))->op__add(string(")")));
	}
	else if (cond(equal_op(syntax_->kind_, IdentifierName_)))
	{
		write_(builder_, mangle_field_name_(get_text_(syntax_)));
	}
	else if (cond(equal_op(syntax_->kind_, StringLiteralExpression_)))
	{
		write_(builder_, string("string(").op__add(get_text_(syntax_))->op__add(string(")")));
	}
	else if (cond(equal_op(syntax_->kind_, AssignmentExpression_)))
	{
		i32 const operator_ = syntax_->children_->op__Element(i32(1))->kind_;
		if (cond(equal_op(operator_, Equals_)))
		{
			convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
			write_(builder_, string(" "));
			write_(builder_, get_text_(syntax_->children_->op__Element(i32(1))));
			write_(builder_, string(" "));
			convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		}
		else
		{
			convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
			convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
			write_(builder_, string("op__"));
			if (cond(equal_op(operator_, PlusEquals_)))
			{
				write_(builder_, string("add_assign"));
			}
			else if (cond(equal_op(operator_, MinusEquals_)))
			{
				write_(builder_, string("subtract_assign"));
			}
			else
			{
				error_(builder_, string("Unsupported assignment operator ").op__add(operator_));
			}
	...
	{
		write_(builder_, string("equal_op("));
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string(", "));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	...
	{
		write_(builder_, string("not_equal_op("));
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string(", "));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	...
	{
		i32 const operator_ = syntax_->children_->op__Element(i32(1))->kind_;
		Type const *_Nonnull const type_ = syntax_->children_->op__Element(i32(0))->of_type_;
		if (cond(not_equal_op(type_, none)))
		{
			write_(builder_, convert_primitive_type_name_(type_));
			if (cond(equal_op(operator_, LessThan_)))
			{
				write_(builder_, string("__op__less_than"));
			}
			else if (cond(equal_op(operator_, LessThanEquals_)))
			{
				write_(builder_, string("__op__less_than_or_equal"));
			}
			else if (cond(equal_op(operator_, GreaterThan_)))
			{
				write_(builder_, string("__op__greater_than"));
			}
			else if (cond(equal_op(operator_, GreaterThanEquals_)))
			{
				write_(builder_, string("__op__greater_than_or_equal"));
			}
			else
			{
				error_(builder_, string("Unsupported comparison operator ").op__add(operator_));
			}
		...
		else
		{
			...
			if (cond(equal_op(operator_, LessThan_)))
			{
				write_(builder_, string("less_than"));
			}
			else if (cond(equal_op(operator_, LessThanEquals_)))
			{
				write_(builder_, string("less_than_or_equal"));
			}
			else if (cond(equal_op(operator_, GreaterThan_)))
			{
				write_(builder_, string("greater_than"));
			}
			else if (cond(equal_op(operator_, GreaterThanEquals_)))
			{
				write_(builder_, string("greater_than_or_equal"));
			}
			else
			{
				error_(builder_, string("Unsupported comparison operator ").op__add(operator_));
	...
	else if (cond(equal_op(syntax_->kind_, AddExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__add("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, SubtractExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__subtract("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, MultiplyExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__multiply("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, DivideExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__divide("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, RemainderExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__remainder("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else if (cond(equal_op(syntax_->kind_, OrExpression_)))
	{
		write_(builder_, string("bit__op(bit__arg("));
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string(") || bit__arg("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string("))"));
	}
	...
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		Semantic_Node const *_Nonnull const parameters_node_ = syntax_->children_->op__Element(i32(1));
		write_(builder_, node_argument_count_(parameters_node_));
		convert_expression_(parameters_node_, builder_);
	}
	else if (cond(equal_op(syntax_->kind_, MemberAccessExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
	...
	else if (cond(equal_op(syntax_->kind_, ElementAccessExpression_)))
	{
		convert_expression_(syntax_->children_->op__Element(i32(0)), builder_);
		convert_member_access_(syntax_->children_->op__Element(i32(0)), builder_);
		write_(builder_, string("op__Element("));
		convert_expression_(syntax_->children_->op__Element(i32(2)), builder_);
		write_(builder_, string(")"));
	}
	else
	{
		error_(builder_, string("Could not convert expression of type ").op__add(syntax_->kind_));
	}
}
...
auto convert_member_access_(Semantic_Node const *_Nonnull const lhs_, Source_File_Builder *_Nonnull const builder_) -> void
{
	...
	if (cond(bit__op(bit__arg(bit__op(bit__arg(not_equal_op(type_, none)) && bit__arg(type_->is_value_type_))) && bit__arg(bit__op__not(bit__op(bit__arg(bit__op(bit__arg(type_->is_primitive_) && bit__arg(equal_op(unqualified_name_(type_->name_), string("optional"))))) && bit__arg(bit__op__not(type_->type_parameters_->op__Element(i32(0))->is_value_type_))))))))
	{
		write_(builder_, string("."));
	}
	else
...
auto emit_statement_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const statement_) -> void
{
	...
	{
		if (cond(equal_op(statement_->children_->op__magnitude(), i32(2))))
		{
			write_line_(emitter_->definitions_, string("return;"));
		}
		else
		{
			begin_line_(emitter_->definitions_, string("return "));
			convert_expression_(statement_->children_->op__Element(i32(1)), emitter_->definitions_);
			end_line_(emitter_->definitions_, string(";"));
		}
	}
	else if (cond(equal_op(statement_->kind_, LoopStatement_)))
	{
		write_line_(emitter_->definitions_, string("for (;;)"));
		emit_statement_(emitter_, statement_->children_->op__Element(i32(1)));
	}
	...
	{
		begin_line_(emitter_->definitions_, string("while (cond("));
		convert_expression_(statement_->children_->op__Element(i32(1)), emitter_->definitions_);
		end_line_(emitter_->definitions_, string("))"));
		emit_statement_(emitter_, statement_->children_->op__Element(i32(2)));
	}
	else if (cond(equal_op(statement_->kind_, ForStatement_)))
	{
		begin_line_(emitter_->definitions_, string("for ("));
		...
		string const name_ = get_text_(first_child_(variable_declaration_, Identifier_));
		Semantic_Node const *_Nonnull const type_ = variable_declaration_->children_->op__Element(i32(2));
		write_(emitter_->definitions_, convert_type_(mutable_binding_, type_)->op__add(string(" "))->op__add(mangle_field_name_(name_)));
		write_(emitter_->definitions_, string(" : *("));
		convert_expression_(statement_->children_->op__Element(i32(3)), emitter_->definitions_);
		end_line_(emitter_->definitions_, string("))"));
		emit_statement_(emitter_, statement_->children_->op__Element(i32(4)));
	}
	else if (cond(equal_op(statement_->kind_, DoWhileStatement_)))
	{
		write_line_(emitter_->definitions_, string("do"));
		emit_statement_(emitter_, statement_->children_->op__Element(i32(1)));
		begin_line_(emitter_->definitions_, string("while (cond("));
		convert_expression_(statement_->children_->op__Element(i32(3)), emitter_->definitions_);
		end_line_(emitter_->definitions_, string("));"));
	...
	else if (cond(equal_op(statement_->kind_, IfStatement_)))
	{
		...
		begin_line_(emitter_->definitions_, string(""));
		for (;;)
		{
			write_(emitter_->definitions_, string("if (cond("));
			convert_expression_(if_statement_->children_->op__Element(i32(1)), emitter_->definitions_);
			end_line_(emitter_->definitions_, string("))"));
			emit_statement_(emitter_, if_statement_->children_->op__Element(i32(2)));
			...
			if (cond(not_equal_op(elseClause_, none)))
			{
				...
				{
					begin_line_(emitter_->definitions_, string("else "));
				}
				else
				{
					write_line_(emitter_->definitions_, string("else"));
					emit_statement_(emitter_, elseClause_->children_->op__Element(i32(1)));
					break;
				}
			}
			else
	...
	{
		write_line_(emitter_->definitions_, string("break;"));
	}
	else if (cond(equal_op(statement_->kind_, ContinueStatement_)))
	{
		write_line_(emitter_->definitions_, string("continue;"));
	}
	else if (cond(equal_op(statement_->kind_, LocalDeclarationStatement_)))
	{
		Semantic_Node const *_Nonnull const variable_declaration_ = first_child_(statement_, VariableDeclaration_);
		string const variable_name_ = get_text_(first_child_(variable_declaration_, Identifier_));
		Semantic_Node const *_Nonnull const variable_type_ = variable_declaration_->children_->op__Element(i32(2));
		bit const mutable_binding_ = node_has_child_(variable_declaration_, VarKeyword_);
		begin_line_(emitter_->definitions_, convert_type_(mutable_binding_, variable_type_));
		write_(emitter_->definitions_, string(" ").op__add(mangle_field_name_(variable_name_)));
		if (cond(variable_declaration_->children_->op__magnitude()->op__greater_than(i32(3))))
		{
			write_(emitter_->definitions_, string(" = "));
			convert_expression_(variable_declaration_->children_->op__Element(i32(3)), emitter_->definitions_);
		}
	...
	{
		begin_line_(emitter_->definitions_, string(""));
		convert_expression_(statement_->children_->op__Element(i32(0)), emitter_->definitions_);
		end_line_(emitter_->definitions_, string(";"));
	}
	else
	{
		NOT_IMPLEMENTED_(string("statement.kind=").op__add(statement_->kind_));
	}
}
...
{
	begin_block_(emitter_->definitions_);
	if (cond(bit__op__not(is_associated_function_)))
	{
		write_line_(emitter_->definitions_, string("auto self = this;"));
	}
...
auto emit_constructor_body_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const block_, string const self_type_, bit const is_value_type_) -> void
{
	...
	{
		write_line_(emitter_->definitions_, self_type_.op__add(string(" self;")));
	}
	...
	write_line_(emitter_->definitions_, string("return self;"));
	end_block_(emitter_->definitions_);
}
...
auto emit_member_declaration_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const member_, string const class_name_, bit const is_value_type_) -> void
{
	if (cond(equal_op(member_->kind_, ConstructorDeclaration_)))
	{
		...
		string new_function_name_ = string("new_").op__add(class_name_);
		string constructor_full_name_ = class_name_.op__add(string("__new__"));
		...
		{
			string const constructor_name_ = get_text_(constructor_name_node_);
			new_function_name_ = new_function_name_.op__add(string("__"))->op__add(constructor_name_);
			constructor_full_name_ = constructor_full_name_.op__add(constructor_name_)->op__add(string("__"));
		}

		constructor_full_name_ = constructor_full_name_.op__add(parameters_node_->children_->op__magnitude());
		string return_type_ = class_name_;
		if (cond(bit__op__not(is_value_type_)))
		{
			return_type_ = return_type_.op__add(string(" *_Nonnull"));
		}

		string constructor_parameters_;
		if (cond(bit__op__not(is_value_type_)))
		{
		...
		string constructor_signature_ = return_type_.op__add(string(" "))->op__add(constructor_full_name_)->op__add(constructor_parameters_);
		write_line_(emitter_->function_declarations_, constructor_signature_.op__add(string(";")));
		...
		string const new_function_signature_ = string("inline ").op__add(return_type_)->op__add(string(" "))->op__add(new_function_name_)->op__add(convert_parameter_list_(emitter_, parameters_node_));
		write_line_(emitter_->function_declarations_, new_function_signature_.op__add(string(";")));
		element_separator_line_(emitter_->definitions_);
		write_line_(emitter_->definitions_, new_function_signature_);
		begin_block_(emitter_->definitions_);
		if (cond(bit__op__not(is_value_type_)))
		{
			begin_line_(emitter_->definitions_, string("return ").op__add(constructor_full_name_)->op__add(string("(new "))->op__add(class_name_)->op__add(string("()")));
		}
		else
		{
			begin_line_(emitter_->definitions_, string("return ").op__add(constructor_full_name_)->op__add(string("(")));
		}
		...
		for (Semantic_Node const *_Nonnull const parameter_ : *(first_child_(member_, ParameterList_)->children_))
		{
			...
			write_(emitter_->definitions_, mangle_field_name_(get_text_(first_child_(parameter_, Identifier_))));
		}
	...
	else if (cond(equal_op(member_->kind_, FieldDeclaration_)))
	{
		...
		string const field_name_ = get_text_(first_child_(variable_declaration_, Identifier_));
		Semantic_Node const *_Nonnull const field_type_ = variable_declaration_->children_->op__Element(i32(2));
		string const cpp_type_ = convert_type_(bit__true, field_type_);
		write_line_(emitter_->class_declarations_, cpp_type_.op__add(string(" "))->op__add(mangle_field_name_(field_name_))->op__add(string(";")));
	}
	else if (cond(equal_op(member_->kind_, MethodDeclaration_)))
	{
		Semantic_Node const *_Nonnull const parameters_node_ = first_child_(member_, ParameterList_);
		Semantic_Node const *_Nullable const self_parameter_ = first_child_(parameters_node_, SelfParameter_);
		i32 parameter_count_ = parameters_node_->children_->op__magnitude();
		if (cond(not_equal_op(self_parameter_, none)))
		{
			parameter_count_.op__subtract_assign(i32(1));
		}

		string const method_name_ = mangle_function_name_(get_text_(first_child_(member_, Identifier_)), parameter_count_);
		string const parameters_ = convert_parameter_list_(emitter_, parameters_node_);
		bit const is_associated_function_ = equal_op(self_parameter_, none);
		bit const mutable_self_ = bit__op(bit__arg(bit__op__not(is_associated_function_)) && bit__arg(node_has_child_(self_parameter_, MutableKeyword_)));
		Semantic_Node const *_Nonnull const return_type_node_ = member_->children_->op__Element(i32(3));
		string const cpp_type_ = convert_type_(bit__true, return_type_node_);
		string static_modifier_ = string("");
		if (cond(is_associated_function_))
		{
			static_modifier_ = string("static ");
		}

		string constModifier_ = string("");
		if (cond(bit__op(bit__arg(bit__op__not(mutable_self_)) && bit__arg(bit__op__not(is_associated_function_)))))
		{
			constModifier_ = string("const ");
		}

		write_line_(emitter_->class_declarations_, static_modifier_.op__add(string("auto "))->op__add(method_name_)->op__add(parameters_)->op__add(string(" "))->op__add(constModifier_)->op__add(string("-> "))->op__add(cpp_type_)->op__add(string(";")));
		element_separator_line_(emitter_->definitions_);
		write_line_(emitter_->definitions_, string("auto ::").op__add(class_name_)->op__add(string("::"))->op__add(method_name_)->op__add(parameters_)->op__add(string(" "))->op__add(constModifier_)->op__add(string("-> "))->op__add(cpp_type_));
	...
	{
		error_(emitter_->definitions_, string("Could not emit member of type ").op__add(member_->kind_));
	}
}

auto emit_default_constructor_(Emitter *_Nonnull const emitter_, string const type_name_, bit const is_value_type_) -> void
{
	string const default_constructor_name_ = type_name_.op__add(string("__new__0"));
	string return_type_ = type_name_;
	if (cond(bit__op__not(is_value_type_)))
	{
		return_type_ = return_type_.op__add(string(" *_Nonnull"));
	}

	string constructor_signature_ = return_type_.op__add(string(" "))->op__add(default_constructor_name_)->op__add(string("("));
	if (cond(bit__op__not(is_value_type_)))
	{
		constructor_signature_ = constructor_signature_.op__add(return_type_)->op__add(string(" self"));
	}

	constructor_signature_ = constructor_signature_.op__add(string(")"));
	write_line_(emitter_->function_declarations_, constructor_signature_.op__add(string(";")));
	element_separator_line_(emitter_->definitions_);
	begin_line_(emitter_->definitions_, constructor_signature_);
	if (cond(is_value_type_))
	{
		end_line_(emitter_->definitions_, string(" { return {}; }"));
	}
	else
	{
		end_line_(emitter_->definitions_, string(" { return self; }"));
	}

	string const new_function_signature_ = string("inline ").op__add(return_type_)->op__add(string(" new_"))->op__add(type_name_)->op__add(string("()"));
	write_line_(emitter_->function_declarations_, new_function_signature_.op__add(string(";")));
	element_separator_line_(emitter_->definitions_);
	write_line_(emitter_->definitions_, new_function_signature_);
	begin_block_(emitter_->definitions_);
	if (cond(bit__op__not(is_value_type_)))
	{
		write_line_(emitter_->definitions_, string("return ").op__add(default_constructor_name_)->op__add(string("(new "))->op__add(type_name_)->op__add(string("());")));
	}
	else
	{
		write_line_(emitter_->definitions_, string("return ").op__add(default_constructor_name_)->op__add(string("();")));
	}
...
auto emit_declaration_(Emitter *_Nonnull const emitter_, Semantic_Node const *_Nonnull const declaration_) -> void
{
	if (cond(equal_op(declaration_->kind_, GlobalDeclaration_)))
	{
		...
		Semantic_Node const *_Nonnull const variable_type_ = variable_declaration_->children_->op__Element(i32(2));
		bit const mutable_binding_ = node_has_child_(variable_declaration_, VarKeyword_);
		string const cpp_type_ = convert_type_(mutable_binding_, variable_type_);
		begin_line_(emitter_->global_definitions_, cpp_type_);
		write_(emitter_->global_definitions_, string(" ").op__add(mangle_field_name_(variable_name_))->op__add(string(" = ")));
		Semantic_Node const *_Nonnull const expression_ = variable_declaration_->children_->op__Element(i32(3));
		convert_expression_(expression_, emitter_->global_definitions_);
		end_line_(emitter_->global_definitions_, string(";"));
	}
	else if (cond(equal_op(declaration_->kind_, ClassDeclaration_)))
	{
		...
		string const class_name_ = mangle_name_(declared_type_->name_);
		write_line_(emitter_->type_declarations_, string("typedef struct ").op__add(class_name_)->op__add(string(" "))->op__add(class_name_)->op__add(string(";")));
		element_separator_line_(emitter_->class_declarations_);
		write_line_(emitter_->class_declarations_, string("struct ").op__add(class_name_));
		begin_block_(emitter_->class_declarations_);
		bit has_constructors_ = bit__false;
		for (Semantic_Node const *_Nonnull const member_ : *(node_members_(declaration_)))
		{
			has_constructors_ = bit__op(bit__arg(has_constructors_) || bit__arg(equal_op(member_->kind_, ConstructorDeclaration_)));
			emit_member_declaration_(emitter_, member_, class_name_, bit__false);
		}

		if (cond(bit__op__not(has_constructors_)))
		{
			emit_default_constructor_(emitter_, class_name_, bit__false);
		}
	...
	else if (cond(equal_op(declaration_->kind_, StructDeclaration_)))
	{
		Type const *_Nonnull const declared_type_ = declaration_->declares_type_;
		assert_(not_equal_op(declared_type_, none), get_text_(first_child_(declaration_, Identifier_)));
		string const struct_name_ = mangle_name_(declared_type_->name_);
		write_line_(emitter_->type_declarations_, string("typedef struct ").op__add(struct_name_)->op__add(string(" "))->op__add(struct_name_)->op__add(string(";")));
		element_separator_line_(emitter_->class_declarations_);
		write_line_(emitter_->class_declarations_, string("struct ").op__add(struct_name_));
		begin_block_(emitter_->class_declarations_);
		write_line_(emitter_->class_declarations_, struct_name_.op__add(string(" * operator->() { return this; }")));
		write_line_(emitter_->class_declarations_, struct_name_.op__add(string(" const * operator->() const { return this; }")));
		write_line_(emitter_->class_declarations_, struct_name_.op__add(string(" & operator* () { return *this; }")));
		write_line_(emitter_->class_declarations_, struct_name_.op__add(string(" const & operator* () const { return *this; }")));
		bit has_constructors_ = bit__false;
		for (Semantic_Node const *_Nonnull const member_ : *(node_members_(declaration_)))
		{
			has_constructors_ = bit__op(bit__arg(has_constructors_) || bit__arg(equal_op(member_->kind_, ConstructorDeclaration_)));
			emit_member_declaration_(emitter_, member_, struct_name_, bit__true);
		}

		if (cond(bit__op__not(has_constructors_)))
		{
			emit_default_constructor_(emitter_, struct_name_, bit__true);
		}
	...
	{
		string const enum_name_ = get_text_(first_child_(declaration_, Identifier_));
		write_line_(emitter_->type_declarations_, string("enum class ").op__add(enum_name_)->op__add(string("_;")));
		element_separator_line_(emitter_->class_declarations_);
		write_line_(emitter_->class_declarations_, string("enum class ").op__add(enum_name_)->op__add(string("_")));
		begin_block_(emitter_->class_declarations_);
		for (Semantic_Node const *_Nonnull const member_ : *(declaration_->children_))
		{
			...
			{
				string const member_name_ = get_text_(member_->children_->op__Element(i32(0)));
				begin_line_(emitter_->class_declarations_, member_name_.op__add(string("_")));
				Semantic_Node const *_Nullable const member_value_ = first_child_(member_, Number_);
				if (cond(not_equal_op(member_value_, none)))
				{
					write_(emitter_->class_declarations_, string(" = "));
					write_(emitter_->class_declarations_, get_text_(member_value_));
				}

				end_line_(emitter_->class_declarations_, string(","));
			}
		}
	...
	{
		Semantic_Node const *_Nonnull const parameters_node_ = first_child_(declaration_, ParameterList_);
		string name_ = get_text_(first_child_(declaration_, Identifier_));
		bit const is_main_ = equal_op(name_, string("main"));
		name_ = mangle_function_name_(name_, parameters_node_->children_->op__magnitude());
		if (cond(is_main_))
		{
			emitter_->main_function_name_ = name_;
		}

		string const parameters_ = convert_parameter_list_(emitter_, parameters_node_, is_main_);
		Semantic_Node const *_Nonnull const return_type_node_ = declaration_->children_->op__Element(i32(3));
		string const cpp_type_ = convert_type_(bit__true, return_type_node_);
		write_line_(emitter_->function_declarations_, string("auto ").op__add(name_)->op__add(parameters_)->op__add(string(" -> "))->op__add(cpp_type_)->op__add(string(";")));
		element_separator_line_(emitter_->definitions_);
		write_line_(emitter_->definitions_, string("auto ").op__add(name_)->op__add(parameters_)->op__add(string(" -> "))->op__add(cpp_type_));
		if (cond(is_main_))
		{
			if (cond(not_equal_op(emitter_->main_function_return_type_, string(""))))
			{
				error_(emitter_->definitions_, string("Multiple declarations of main"));
			}
	...
	{
		error_(emitter_->definitions_, string("Could not emit declaration of type ").op__add(declaration_->kind_));
	}
}
...
auto emit_preamble_(Emitter *_Nonnull const emitter_) -> void
{
	write_line_(emitter_->type_declarations_, string("#include \"RuntimeLibrary.hpp\""));
	blank_line_(emitter_->type_declarations_);
	write_line_(emitter_->type_declarations_, string("// Type Declarations"));
	blank_line_(emitter_->function_declarations_);
	write_line_(emitter_->function_declarations_, string("// Function Declarations"));
	blank_line_(emitter_->class_declarations_);
	write_line_(emitter_->class_declarations_, string("// Class Declarations"));
	blank_line_(emitter_->global_definitions_);
	write_line_(emitter_->global_definitions_, string("// Global Definitions"));
	blank_line_(emitter_->definitions_);
	write_line_(emitter_->definitions_, string("// Definitions"));
}

auto emit_entry_point_adapter_(Emitter *_Nonnull const emitter_) -> void
{
	element_separator_line_(emitter_->definitions_);
	write_line_(emitter_->definitions_, string("// Entry Point Adapter"));
	write_line_(emitter_->definitions_, string("std::int32_t main(int argc, char const *const * argv)"));
	begin_block_(emitter_->definitions_);
	write_line_(emitter_->definitions_, string("try"));
	begin_block_(emitter_->definitions_);
	for (Source_Text const *_Nonnull const resource_ : *(emitter_->resources_))
	{
		begin_line_(emitter_->definitions_, string("resource_manager__->AddResource(string(\""));
		write_(emitter_->definitions_, resource_->name_);
		write_(emitter_->definitions_, string("\"), string(\""));
		write_(emitter_->definitions_, resource_->text_.Replace_(string("\\"), string("\\\\"))->Replace_(string("\n"), string("\\n"))->Replace_(string("\r"), string("\\r"))->Replace_(string("\""), string("\\\"")));
		end_line_(emitter_->definitions_, string("\"));"));
	}

	if (cond(emitter_->resources_->op__magnitude()->op__greater_than(i32(0))))
	{
		end_line_(emitter_->definitions_, string(""));
	}
	...
	{
		args_->Append_(string("new system__console__Console()"));
	}
	...
	if (cond(emitter_->main_function_accepts_args_))
	{
		...
		args_->Append_(string("new system__console__Arguments(argc, argv)"));
	}

	if (cond(equal_op(emitter_->main_function_return_type_, string("void"))))
	{
		write_line_(emitter_->definitions_, emitter_->main_function_name_.op__add(string("("))->op__add(args_->ToString_())->op__add(string(");")));
		write_line_(emitter_->definitions_, string("return 0;"));
	}
	else
	{
		write_line_(emitter_->definitions_, string("return ").op__add(emitter_->main_function_name_)->op__add(string("("))->op__add(args_->ToString_())->op__add(string(").value;")));
	}

	end_block_(emitter_->definitions_);
	write_line_(emitter_->definitions_, string("catch(std::exception &ex)"));
	begin_block_(emitter_->definitions_);
	write_line_(emitter_->definitions_, string("std::printf(\"Program exited due to error:\\n\");"));
	write_line_(emitter_->definitions_, string("std::printf(\"%s\", ex.what());"));
	write_line_(emitter_->definitions_, string("return 70;"));
	end_block_(emitter_->definitions_);
	end_block_(emitter_->definitions_);
}
...
Name *_Nonnull Name__new__global_namespace__0(Name *_Nonnull self)
{
	...
	self->segments_ = new_system__collections__List<string>();
	self->is_special_ = bit__false;
	return self;
}
...
Name *_Nonnull Name__new__global_namespace__1(Name *_Nonnull self, Package_Name const *_Nonnull const package_)
{
	assert_(not_equal_op(package_, none), string(""));
	self->package_ = package_;
	self->kind_ = NamespaceName_;
	self->segments_ = new_system__collections__List<string>();
	self->is_special_ = bit__false;
...
inline Name *_Nonnull new_Name__global_namespace(Package_Name const *_Nonnull const package_)
{
	return Name__new__global_namespace__1(new Name(), package_);
}

Name *_Nonnull Name__new__3(Name *_Nonnull self, Name const *_Nonnull const qualifier_, i32 const kind_, string const name_)
{
	assert_(not_equal_op(qualifier_, none), string(""));
	assert_(name_.ByteLength_()->op__greater_than(i32(0)), string(""));
	self->package_ = qualifier_->package_;
	self->kind_ = kind_;
	system__collections__List<string> *_Nonnull const segments_ = new_system__collections__List<string>();
	for (string const segment_ : *(qualifier_->segments_))
	{
...
inline Name *_Nonnull new_Name(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_)
{
	return Name__new__3(new Name(), qualifier_, kind_, name_);
}
...
inline Name *_Nonnull new_Name(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_, bit const is_special_)
{
	return Name__new__4(new Name(), qualifier_, kind_, name_, is_special_);
}
...
Name *_Nonnull Name__new__special__3(Name *_Nonnull self, Name const *_Nonnull const qualifier_, i32 const kind_, string const name_)
{
	...
	segments_->add_(name_);
	self->segments_ = segments_;
	self->is_special_ = bit__true;
	return self;
}

inline Name *_Nonnull new_Name__special(Name const *_Nonnull const qualifier_, i32 const kind_, string const name_)
{
	return Name__new__special__3(new Name(), qualifier_, kind_, name_);
}
...
inline Name *_Nonnull new_Name(Package_Name const *_Nullable const package_, i32 const kind_, system__collections__List<string> const *_Nonnull const segments_, bit const is_special_)
{
	return Name__new__4(new Name(), package_, kind_, segments_, is_special_);
}

auto unqualified_name_(Name const *_Nonnull const name_) -> string
{
	if (cond(equal_op(name_->segments_->op__magnitude(), i32(0))))
	{
		return string("");
	}

	return name_->segments_->op__Element(name_->segments_->op__magnitude()->op__subtract(i32(1)));
}
...
auto full_name_(Name const *_Nonnull const name_) -> string
{
	...
	result_ = result_.op__add(string("::"));
	bit first_ = bit__true;
	for (string const segment_ : *(name_->segments_))
	{
		if (cond(first_))
		{
			first_ = bit__false;
			result_ = result_.op__add(segment_);
			continue;
		}

		result_ = result_.op__add(string("."))->op__add(segment_);
	}
...
auto is_qualified_by_(Name const *_Nonnull const name_, Name const *_Nonnull const qualifier_) -> bit
{
	if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(not_equal_op(name_->package_, none)) && bit__arg(not_equal_op(qualifier_->package_, none)))) && bit__arg(not_equal_op(full_name_(name_->package_), full_name_(qualifier_->package_))))) || bit__arg(name_->segments_->op__magnitude()->op__less_than_or_equal(qualifier_->segments_->op__magnitude())))))
	{
		return bit__false;
	}
	...
	for (string const segment_ : *(qualifier_->segments_))
	{
		if (cond(not_equal_op(segment_, name_->segments_->op__Element(i_))))
		{
			return bit__false;
		}
...
auto qualifier_is_(Name const *_Nonnull const name_, Name const *_Nonnull const qualifier_) -> bit
{
	return bit__op(bit__arg(equal_op(qualifier_->segments_->op__magnitude()->op__add(i32(1)), name_->segments_->op__magnitude())) && bit__arg(is_qualified_by_(name_, qualifier_)));
}

auto names_(Name const *_Nonnull const name_, Name const *_Nonnull const other_) -> bit
{
	if (cond(bit__op(bit__arg(bit__op(bit__arg(not_equal_op(name_->package_, none)) && bit__arg(bit__op(bit__arg(equal_op(other_->package_, none)) || bit__arg(not_equal_op(full_name_(name_->package_), full_name_(other_->package_))))))) || bit__arg(not_equal_op(name_->segments_->op__magnitude(), other_->segments_->op__magnitude())))))
	{
		return bit__false;
	}

	i32 i_ = i32(0);
	for (string const segment_ : *(other_->segments_))
	{
		if (cond(not_equal_op(segment_, name_->segments_->op__Element(i_))))
		{
			return bit__false;
...
auto name_with_unspecified_package_names_name_with_package_() -> void
{
	Name const *_Nonnull const name_without_package_ = new_Name(new_Name__global_namespace(), NamespaceName_, string("system"));
	Name const *_Nonnull const name_with_package_ = new_Name(new_Name__global_namespace(new_Package_Name(string("package"))), NamespaceName_, string("system"));
	assert_(names_(name_without_package_, name_with_package_), string(""));
}

auto name_with_unspecified_package_names_itself_() -> void
{
	Name const *_Nonnull const name_without_package_ = new_Name(new_Name__global_namespace(), NamespaceName_, string("system"));
	assert_(names_(name_without_package_, name_without_package_), string(""));
}
...
inline Package_Name *_Nonnull new_Package_Name(string const name_)
{
	return Package_Name__new__1(new Package_Name(), name_);
}
...
Symbol *_Nonnull Symbol__new__identifier__1(Symbol *_Nonnull self, string const name_)
{
	...
	self->is_special_name_ = bit__false;
	self->of_type_ = none;
	self->declares_type_ = none;
...
inline Symbol *_Nonnull new_Symbol__identifier(string const name_)
{
	return Symbol__new__identifier__1(new Symbol(), name_);
}

Symbol *_Nonnull Symbol__new__identifier__2(Symbol *_Nonnull self, string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_)
{
	assert_(name_.ByteLength_()->op__greater_than(i32(0)), string(""));
	assert_(not_equal_op(declarations_, none), string("name=").op__add(name_));
	self->name_ = name_;
	self->kind_ = IdentifierSymbol_;
	self->is_special_name_ = bit__false;
	self->of_type_ = none;
...
inline Symbol *_Nonnull new_Symbol__identifier(string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_)
{
	return Symbol__new__identifier__2(new Symbol(), name_, declarations_);
}

Symbol *_Nonnull Symbol__new__identifier__2(Symbol *_Nonnull self, string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	assert_(name_.ByteLength_()->op__greater_than(i32(0)), string(""));
	assert_(not_equal_op(children_, none), string("name=").op__add(name_));
	self->name_ = name_;
	self->kind_ = IdentifierSymbol_;
	self->is_special_name_ = bit__false;
	self->of_type_ = none;
...
inline Symbol *_Nonnull new_Symbol__identifier(string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	return Symbol__new__identifier__2(new Symbol(), name_, children_);
}
...
Symbol *_Nonnull Symbol__new__constructor__2(Symbol *_Nonnull self, string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_)
{
	...
	self->name_ = name_;
	self->kind_ = IdentifierSymbol_;
	self->is_special_name_ = bit__true;
	self->of_type_ = none;
	self->declares_type_ = none;
	self->declarations_ = declarations_;
	self->children_ = new_system__collections__List<Symbol const *_Nonnull>();
...
inline Symbol *_Nonnull new_Symbol__constructor(string const name_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_)
{
	return Symbol__new__constructor__2(new Symbol(), name_, declarations_);
}
...
inline Symbol *_Nonnull new_Symbol__package(string const name_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	return Symbol__new__package__2(new Symbol(), name_, children_);
}

Symbol *_Nonnull Symbol__new__declaring__3(Symbol *_Nonnull self, Type const *_Nonnull const declares_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	assert_(not_equal_op(declares_type_, none), string(""));
	assert_(not_equal_op(declarations_, none), string("name=").op__add(unqualified_name_(declares_type_->name_)));
	assert_(not_equal_op(children_, none), string("name=").op__add(unqualified_name_(declares_type_->name_)));
...
inline Symbol *_Nonnull new_Symbol__declaring(Type const *_Nonnull const declares_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	return Symbol__new__declaring__3(new Symbol(), declares_type_, declarations_, children_);
}

Symbol *_Nonnull Symbol__new__of_type__4(Symbol *_Nonnull self, string const name_, Type const *_Nonnull const of_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	assert_(not_equal_op(of_type_, none), string("name=").op__add(name_));
	assert_(not_equal_op(declarations_, none), string("name=").op__add(name_));
	assert_(not_equal_op(children_, none), string("name=").op__add(name_));
	self->name_ = name_;
	self->is_special_name_ = bit__false;
...
inline Symbol *_Nonnull new_Symbol__of_type(string const name_, Type const *_Nonnull const of_type_, system__collections__List<Semantic_Node const *_Nonnull> const *_Nonnull const declarations_, system__collections__List<Symbol const *_Nonnull> const *_Nonnull const children_)
{
	return Symbol__new__of_type__4(new Symbol(), name_, of_type_, declarations_, children_);
}
...
auto get_child_(Symbol const *_Nonnull const symbol_, string const name_, i32 const kind_) -> Symbol const *_Nullable
{
	...
	{
		if (cond(bit__op(bit__arg(equal_op(child_->name_, name_)) && bit__arg(equal_op(child_->kind_, kind_)))))
		{
			return child_;
		}
	}
...
{
	system__collections__List<Symbol const *_Nonnull> *_Nonnull const children_ = new_system__collections__List<Symbol const *_Nonnull>();
	children_->add_(new_Symbol__identifier(string("child")));
	Symbol const *_Nonnull const package_with_children_ = new_Symbol__package(string("package"), children_);
	assert_(not_equal_op(get_child_(package_with_children_, string("child"), IdentifierSymbol_), none), string(""));
}

Type *_Nonnull Type__new__3(Type *_Nonnull self, i32 const kind_, Name const *_Nonnull const name_, bit const is_mutable_)
{
	assert_(not_equal_op(name_, none), string(""));
	self->kind_ = kind_;
	self->name_ = name_;
	self->type_parameters_ = new_system__collections__List<Type const *_Nonnull>();
	self->is_primitive_ = bit__false;
...
inline Type *_Nonnull new_Type(i32 const kind_, Name const *_Nonnull const name_, bit const is_mutable_)
{
	return Type__new__3(new Type(), kind_, name_, is_mutable_);
}
...
Type *_Nonnull Type__new__parameter__1(Type *_Nonnull self, string const name_)
{
	...
	self->type_parameters_ = new_system__collections__List<Type const *_Nonnull>();
	self->is_primitive_ = bit__false;
	self->is_value_type_ = bit__false;
	self->is_potentially_mutable_ = bit__true;
	self->is_mutable_ = bit__false;
	return self;
}

inline Type *_Nonnull new_Type__parameter(string const name_)
{
	return Type__new__parameter__1(new Type(), name_);
}
...
inline Type *_Nonnull new_Type(i32 const kind_, Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_, bit const is_mutable_)
{
	return Type__new__4(new Type(), kind_, name_, type_parameters_, is_mutable_);
}
...
Type *_Nonnull Type__new__primitive__1(Type *_Nonnull self, Name const *_Nonnull const name_)
{
	...
	self->name_ = name_;
	self->type_parameters_ = new_system__collections__List<Type const *_Nonnull>();
	self->is_primitive_ = bit__true;
	self->is_value_type_ = bit__true;
	self->is_potentially_mutable_ = bit__false;
	self->is_mutable_ = bit__false;
	return self;
}
...
inline Type *_Nonnull new_Type__primitive(Name const *_Nonnull const name_)
{
	return Type__new__primitive__1(new Type(), name_);
}
...
inline Type *_Nonnull new_Type__primitive(Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_)
{
	return Type__new__primitive__2(new Type(), name_, type_parameters_);
}
...
inline Type *_Nonnull new_Type__namespace(Name const *_Nonnull const name_)
{
	return Type__new__namespace__1(new Type(), name_);
}

Type *_Nonnull Type__new__generic__2(Type *_Nonnull self, Type const *_Nonnull const definition_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_arguments_)
{
	assert_(not_equal_op(definition_, none), string(""));
	assert_(not_equal_op(type_arguments_, none), full_name_(definition_->name_));
	assert_(equal_op(definition_->type_parameters_->op__magnitude(), type_arguments_->op__magnitude()), full_name_(definition_->name_)->op__add(string(" "))->op__add(definition_->type_parameters_->op__magnitude())->op__add(string(" given "))->op__add(type_arguments_->op__magnitude()));
...
inline Type *_Nonnull new_Type__generic(Type const *_Nonnull const definition_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_arguments_)
{
	return Type__new__generic__2(new Type(), definition_, type_arguments_);
}
...
inline Type *_Nonnull new_Type(i32 const kind_, Name const *_Nonnull const name_, system__collections__List<Type const *_Nonnull> const *_Nonnull const type_parameters_, bit const is_primitive_, bit const is_potentially_mutable_, bit const is_mutable_)
{
	return Type__new__6(new Type(), kind_, name_, type_parameters_, is_primitive_, is_potentially_mutable_, is_mutable_);
}

auto make_mutable_type_(Type const *_Nonnull const type_) -> Type const *_Nonnull
{
	assert_(type_->is_potentially_mutable_, string("self.name=").op__add(full_name_(type_->name_)));
	return new_Type(type_->kind_, type_->name_, type_->type_parameters_, type_->is_primitive_, type_->is_potentially_mutable_, bit__true);
}

auto make_immutable_type_(Type const *_Nonnull const type_) -> Type const *_Nonnull
{
	return new_Type(type_->kind_, type_->name_, type_->type_parameters_, type_->is_primitive_, type_->is_potentially_mutable_, bit__false);
}

auto remove_type_package_(Type const *_Nonnull const type_) -> Type const *_Nonnull
{
	assert_(equal_op(type_->kind_, NamespaceType_), string("kind=").op__add(type_->kind_));
...
inline Name_Subtable *_Nonnull new_Name_Subtable__global_namespace(Name_Table const *_Nonnull const name_table_)
{
	return Name_Subtable__new__global_namespace__1(new Name_Subtable(), name_table_);
}
...
inline Name_Subtable *_Nonnull new_Name_Subtable__global_namespace(Name_Table const *_Nonnull const name_table_, Package_Name const *_Nonnull const package_name_)
{
	return Name_Subtable__new__global_namespace__2(new Name_Subtable(), name_table_, package_name_);
}
...
inline Name_Subtable *_Nonnull new_Name_Subtable(Name_Subtable const *_Nonnull const parent_, Name const *_Nonnull const name_, Type const *_Nonnull const type_)
{
	return Name_Subtable__new__3(new Name_Subtable(), parent_, name_, type_);
}

auto add_subtable_(Name_Subtable *_Nonnull const scope_, Name const *_Nonnull const name_, Type const *_Nonnull const type_) -> void
{
	assert_(is_qualified_by_(name_, scope_->name_), string("\"").op__add(full_name_(name_))->op__add(string("\" is not a child of \""))->op__add(full_name_(scope_->name_))->op__add(string("\"")));
	if (cond(qualifier_is_(name_, scope_->name_)))
	{
		if (cond(bit__op(bit__arg(bit__op(bit__arg(equal_op(scope_->name_->package_, none)) && bit__arg(not_equal_op(type_, none)))) && bit__arg(equal_op(type_->kind_, NamespaceType_)))))
		{
	...
	assert_(equal_op(name_->segments_->op__magnitude(), scope_->name_->segments_->op__magnitude()->op__add(i32(1))), string("Can't add \"").op__add(full_name_(name_))->op__add(string("\" to \""))->op__add(full_name_(scope_->name_))->op__add(string("\"")));
}

auto find_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable
{
	return find_(scope_, name_, bit__false);
}

auto find_special_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable
{
	return find_(scope_, name_, bit__true);
}
...
auto find_(Name_Subtable const *_Nonnull const scope_, string const name_, bit const is_special_) -> Name_Subtable *_Nullable
{
	for (Name_Subtable *_Nonnull const subtable_ : *(scope_->subtables_))
	{
		if (cond(bit__op(bit__arg(equal_op(unqualified_name_(subtable_->name_), name_)) && bit__arg(equal_op(subtable_->name_->is_special_, is_special_)))))
		{
			return subtable_;
		}
	}
...
auto lookup_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable
{
	return lookup_(scope_, name_, bit__false);
}

auto lookup_special_(Name_Subtable const *_Nonnull const scope_, string const name_) -> Name_Subtable *_Nullable
{
	return lookup_(scope_, name_, bit__true);
}

auto lookup_(Name_Subtable const *_Nonnull const scope_, string const name_, bit const is_special_) -> Name_Subtable *_Nullable
{
	Name_Subtable *_Nullable subtable_ = find_(scope_, name_, is_special_);
	if (cond(bit__op(bit__arg(equal_op(subtable_, none)) && bit__arg(not_equal_op(scope_->parent_, none)))))
	{
...
auto get_scope_(Name_Subtable const *_Nonnull const scope_, Name const *_Nonnull const name_) -> Name_Subtable const *_Nullable
{
	...
	else if (cond(bit__op__not(is_qualified_by_(name_, scope_->name_))))
	{
		return none;
	}
...
auto bind_type_(Name_Subtable *_Nonnull const scope_, Type const *_Nonnull const type_) -> void
{
	...
	{
		assert_(equal_op(full_name_(scope_->type_->name_), full_name_(type_->name_)), full_name_(scope_->name_)->op__add(string(" currently `"))->op__add(full_name_(scope_->type_->name_))->op__add(string("` trying to set to `"))->op__add(full_name_(type_->name_))->op__add(string("`")));
	}
...
auto global_namespace_contains_added_name_() -> void
{
	...
	Name const *_Nonnull const test_name_ = new_Name(global_namespace_->name_, TypeName_, string("test"));
	add_subtable_(global_namespace_, test_name_, none);
	assert_(not_equal_op(find_(global_namespace_, string("test")), none), string(""));
	assert_(not_equal_op(get_scope_(global_namespace_, test_name_), none), string(""));
}
...
auto namespace_contains_added_name_() -> void
{
	Name_Table const *_Nonnull const name_table_ = new_Name_Table();
	Name_Subtable *_Nonnull const global_namespace_ = new_Name_Subtable__global_namespace(name_table_);
	Name const *_Nonnull const namespace_name_ = new_Name(global_namespace_->name_, NamespaceName_, string("namespace"));
	add_subtable_(global_namespace_, namespace_name_, none);
	add_subtable_(global_namespace_, new_Name(namespace_name_, TypeName_, string("test")), none);
	Name_Subtable const *_Nonnull const namespace_ = find_(global_namespace_, string("namespace"));
	assert_(not_equal_op(find_(namespace_, string("test")), none), string(""));
}
...
auto add_name_(Name_Table *_Nonnull const name_table_, Name const *_Nonnull const name_, Type const *_Nonnull const type_) -> void
{
	...
	assert_(bit__false, string("Can't add name \"").op__add(full_name_(name_))->op__add(string("\" because package doesn't exist in table.")));
}
...
auto add_compilation_unit_(Name_Table *_Nonnull const name_table_, Name const *_Nonnull const global_namespace_, Syntax_Node const *_Nonnull const compilation_unit_) -> void
{
	assert_(equal_op(compilation_unit_->kind_, CompilationUnit_), string("compilation_unit.kind=").op__add(compilation_unit_->kind_));
...
auto add_syntax_(Name_Table *_Nonnull const name_table_, Name const *_Nonnull const parent_, Syntax_Node const *_Nonnull const syntax_) -> void
{
	...
	{
		string const unqualified_name_ = get_text_(first_child_syntax_(syntax_, Identifier_));
		i32 type_kind_;
		...
		Type const *_Nonnull const type_ = new_Type(type_kind_, name_, bit__true);
	...
	else if (cond(equal_op(syntax_->kind_, ConstructorDeclaration_)))
	{
		...
		add_function_(name_table_, name_, syntax_);
		Name const *_Nonnull const self_name_ = new_Name__special(name_, VariableName_, string("self"));
	...
	{
		string const unqualified_name_ = get_text_(first_child_syntax_(first_child_syntax_(syntax_, VariableDeclaration_), Identifier_));
		Name const *_Nonnull const name_ = new_Name(parent_, TypeName_, unqualified_name_);
	...
	else if (cond(equal_op(syntax_->kind_, EnumDeclaration_)))
	{
		string const unqualified_name_ = get_text_(first_child_syntax_(syntax_, Identifier_));
		Name const *_Nonnull const name_ = new_Name(parent_, TypeName_, unqualified_name_);
		Type const *_Nonnull const type_ = new_Type(ReferenceType_, name_, bit__true);
		add_name_(name_table_, name_, type_);
	}
	...
	else if (cond(bit__op(bit__arg(bit__op(bit__arg(equal_op(syntax_->kind_, LoopStatement_)) || bit__arg(equal_op(syntax_->kind_, WhileStatement_)))) || bit__arg(equal_op(syntax_->kind_, DoWhileStatement_)))))
	{
	...
	{
		Name const *_Nonnull const name_ = new_Name__special(parent_, VariableName_, string("self"));
		Type const *_Nullable const no_type_ = none;
		add_name_(name_table_, name_, no_type_);
	}
	else if (cond(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(bit__op(bit__arg(equal_op(syntax_->kind_, ExpressionStatement_)) || bit__arg(equal_op(syntax_->kind_, ReturnStatement_)))) || bit__arg(equal_op(syntax_->kind_, BreakStatement_)))) || bit__arg(equal_op(syntax_->kind_, ContinueStatement_)))) || bit__arg(equal_op(syntax_->kind_, EndOfFileToken_)))))
	{
	}
	else
	{
		NOT_IMPLEMENTED_(string("syntax.kind=").op__add(syntax_->kind_));
	}
}
...
auto table_contains_referenced_child_names_() -> void
{
	...
	Name_Table const *_Nonnull const name_table_ = build_name_table_(name_, package_syntax_, references_);
	Name_Subtable const *_Nonnull const namespace_ = find_(name_table_->any_package_, string("system"));
	assert_(not_equal_op(find_(namespace_, string("console")), none), string(""));
	Name const *_Nonnull const system_namespace_name_ = new_Name(new_Name__global_namespace(), NamespaceName_, string("system"));
	assert_(not_equal_op(get_name_(name_table_, system_namespace_name_), none), string(""));
	Name const *_Nonnull const console_namespace_name_ = new_Name(system_namespace_name_, NamespaceName_, string("console"));
	assert_(not_equal_op(get_name_(name_table_, console_namespace_name_), none), string(""));
	Name const *_Nonnull const console_class_name_ = new_Name(console_namespace_name_, TypeName_, string("Console"));
	assert_(not_equal_op(get_name_(name_table_, console_class_name_), none), string(""));
}
...
auto can_get_root_namespace_from_name_() -> void
{
	...
	Syntax_Node const *_Nonnull const package_syntax_ = new_Syntax_Node(PackageNode_, none, i32(0), i32(0));
	Name_Table const *_Nonnull const name_table_ = build_name_table_(name_, package_syntax_, references_);
	Name const *_Nonnull const namespace_name_ = new_Name(new_Name__global_namespace(), NamespaceName_, string("system"));
	assert_(not_equal_op(get_name_(name_table_, namespace_name_), none), string(""));
}
...
auto can_get_Optional_class_from_name_with_package_() -> void
{
	...
	Syntax_Node const *_Nonnull const package_syntax_ = new_Syntax_Node(PackageNode_, none, i32(0), i32(0));
	Name_Table const *_Nonnull const name_table_ = build_name_table_(name_, package_syntax_, references_);
	Package_Name const *_Nonnull const package_name_ = new_Package_Name(string("$primitives"));
	Name const *_Nonnull const adamant_namespace_name_ = new_Name(new_Name__global_namespace(), NamespaceName_, string("adamant"));
	Name const *_Nonnull const language_namespace_name_ = new_Name(adamant_namespace_name_, NamespaceName_, string("language"));
	assert_(not_equal_op(get_name_(name_table_, language_namespace_name_), none), string(""));
	Name const *_Nonnull const optional_class_name_ = new_Name(language_namespace_name_, TypeName_, string("optional"));
	assert_(not_equal_op(get_name_(name_table_, optional_class_name_), none), string(""));
}

...
int32 main__2(system__console__Console__0 *_Nonnull const console__, system__console__Arguments__0 const *_Nonnull const args__)
{
	...
	if (cond(verbose__))
	{
		...
		console_write_line__2(console__, outputFilePath__);
	}
	...
	if (cond(verbose__))
	{
		...
		console_write_line__2(console__, outputDirPath__);
	}

...
int32 main__2(system__console__Console__0 *_Nonnull const console__, system__console__Arguments__0 const *_Nonnull const args__)
{
	...
	if (cond(int32__0op__gt(resourceFilePaths__->count__, ((int32){0}))))
	{
		...
		for (string__0iter iter = system__collections__List__1__0iterate(resourceFilePaths__); string__0next(&iter);)
		{
	...
	for (string__0iter iter = system__collections__List__1__0iterate(sourceFilePaths__); string__0next(&iter);)
	{
...
Name__0 *_Nonnull Name__0__0new__3(Name__0 *_Nonnull self, Name__0 const *_Nonnull const qualifier__, int32 const kind__, string const name__)
{
	...
	for (string__0iter iter = system__collections__List__1__0iterate(qualifier__->segments__); string__0next(&iter);)
	{
		string const segment__ = string__0current(&iter);
...
string unqualified_name__1(Name__0 const *_Nonnull const name__)
{
	...
	return system__collections__List__1__0op__element(name__->segments__, int32__0op__sub(name__->segments__->count__, ((int32){1})));
}
...
string full_name__1(Name__0 const *_Nonnull const name__)
{
	...
	BOOL first__ = TRUE;
	for (string__0iter iter = system__collections__List__1__0iterate(name__->segments__); string__0next(&iter);)
	{
		string const segment__ = string__0current(&iter);
		if (cond(first__))
		{
...
BOOL is_qualified_by__2(Name__0 const *_Nonnull const name__, Name__0 const *_Nonnull const qualifier__)
{
	...
	{
		string const segment__ = string__0current(&iter);
		if (cond(string__0op__not_equal(segment__, system__collections__List__1__0op__element(name__->segments__, i__))))
		{
			return FALSE;
		}
...
BOOL names__2(Name__0 const *_Nonnull const name__, Name__0 const *_Nonnull const other__)
{
	...
	int32 i__ = ((int32){0});
	for (string__0iter iter = system__collections__List__1__0iterate(other__->segments__); string__0next(&iter);)
	{
		string const segment__ = string__0current(&iter);
		if (cond(string__0op__not_equal(segment__, system__collections__List__1__0op__element(name__->segments__, i__))))
		{

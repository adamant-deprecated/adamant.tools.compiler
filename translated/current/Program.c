...
void console_write_diagnostics__2(system__console__Console__0 *_Nonnull const console__, system__collections__List__1 const *_Nonnull const diagnostics__);
...
void collect_node_diagnostics__2(Semantic_Node__0 const *_Nonnull const node__, system__collections__List__1 *_Nonnull const diagnostics__);
...
Syntax_Node__0 *_Nonnull Syntax_Node__0__0new__skipped_many__1(Syntax_Node__0 *_Nonnull self, system__collections__List__1 const *_Nonnull const skipped_nodes__);
...
system__collections__List__1 *_Nonnull all_node_diagnostics__1(Syntax_Node__0 const *_Nonnull const syntax__);
...
void convert_type_name_parameters__2(system__text__String_Builder__0 *_Nonnull const builder__, Type__0 const *_Nonnull const type__);
...
Type__0 const *_Nonnull as_type__1(Type__0 const *_Nonnull const type__);
...
Name__0 *_Nonnull Name__0__0new__exactly__4(Name__0 *_Nonnull self, Package_Name__0 const *_Nullable const package__, int32 const kind__, Strings__0 const *_Nonnull const segments__, BOOL const is_special__);
...
string full_package_name__1(Package_Name__0 const *_Nonnull const package_name__);
...
void add_subtable__3(Name_Subtable__0 *_Nonnull const scope__, Name__0 const *_Nonnull const name__, Type__0 const *_Nullable const type__);
...
Name__0 const *_Nonnull add_symbol_name__3(Name_Table__0 *_Nonnull const name_table__, Name__0 const *_Nonnull const parent__, Symbol__0 const *_Nonnull const symbol__);
void add_type_name__3(Name_Table__0 *_Nonnull const name_table__, Name__0 const *_Nonnull const name__, Type__0 const *_Nullable const type__);
...
int32 main__2(system__console__Console__0 *_Nonnull const console__, system__console__Arguments__0 const *_Nonnull const args__)
{
	...
	system__io__File_Writer__0 *_Nonnull resource_file__ = system__io__File_Writer__0__0new__1(allocate(sizeof(system__io__File_Writer__0)), string__0op__add(output_dir_path__, ((string){16,(uint8_t const*)"RuntimeLibrary.h"})));
...
Semantic_Node__0 const *_Nonnull build_semantic_node__4(Semantic_Tree_Builder__0 const *_Nonnull const builder__, Syntax_Node__0 const *_Nonnull const syntax__, Name_Table__0 const *_Nonnull const name_table__, Name_Subtable__0 const *_Nonnull const scope__)
{
	...
	if (cond(bool_op(bool_arg(int32__0op__equal(syntax__->kind__, FunctionDeclaration__)) || bool_arg(int32__0op__equal(syntax__->kind__, MethodDeclaration__)))))
	{
		...
		Name_Subtable__0 *_Nonnull const function_scope__ = find__2(scope__, get_syntax_text__1(function_name__));
	...
	else if (cond(bool_op(bool_arg(int32__0op__equal(syntax__->kind__, ClassDeclaration__)) || bool_arg(int32__0op__equal(syntax__->kind__, StructDeclaration__)))))
	{
		...
		Name_Subtable__0 const *_Nonnull const type_scope__ = find__2(scope__, get_syntax_text__1(type_name__));
	...
	{
		Name_Subtable__0 const *_Nonnull const name_scope__ = lookup__2(scope__, get_syntax_text__1(syntax__));
	...
	else if (cond(int32__0op__equal(syntax__->kind__, MemberAccessExpression__)))
	{
		...
		else
		{
			...
			Name_Subtable__0 const *_Nonnull const member_scope__ = find__2(access_scope__, get_syntax_text__1(member_name__));
	...
	else if (cond(int32__0op__equal(syntax__->kind__, VariableDeclaration__)))
	{
		...
		Name_Subtable__0 *_Nonnull const variable_scope__ = lookup__2(scope__, get_syntax_text__1(identifier__));
...
Semantic_Node__0 *_Nonnull build_parameters_semantic_node__4(Semantic_Tree_Builder__0 const *_Nonnull const builder__, Syntax_Node__0 const *_Nonnull const parameters_syntax__, Name_Table__0 const *_Nonnull const name_table__, Name_Subtable__0 const *_Nonnull const scope__)
{
	...
	for (void_ptr__0iter iter = void_ptr__0iterate(parameters__1(parameters_syntax__)); void_ptr__0next(&iter);)
	{
		...
		if (cond(int32__0op__equal(parameter__->kind__, Parameter__)))
		{
			...
			add_item__2(children__, type_node__);
			Name_Subtable__0 *_Nonnull const parameter_scope__ = lookup__2(scope__, get_syntax_text__1(identifier__));
	...
	else if (cond(int32__0op__equal(syntax__->kind__, QualifiedName__)))
	{
		...
		if (cond(int32__0op__equal(qualified_syntax__->kind__, IdentifierName__)))
		{
			...
			else
			{
				...
				Name_Subtable__0 const *_Nonnull const referenced_scope__ = find__2(containing_scope__, get_syntax_text__1(name_syntax__));
...
Syntax_Node__0 *_Nonnull Syntax_Node__0__0new__with_children__2(Syntax_Node__0 *_Nonnull self, int32 const type__, system__collections__List__1 const *_Nonnull const children__)
{
	self->kind__ = type__;
	self->is_missing__ = FALSE;
	Syntax_Node__0 const *_Nonnull const first_child__ = system__collections__List__1__0op__element(children__, ((int32){0}));
...
Syntax_Node__0 *_Nonnull Syntax_Node__0__0new__skipped_many__1(Syntax_Node__0 *_Nonnull self, system__collections__List__1 const *_Nonnull const skipped_nodes__)
{
	self->kind__ = SkippedTokens__;
	self->is_missing__ = FALSE;
	Syntax_Node__0 const *_Nonnull const first_child__ = system__collections__List__1__0op__element(skipped_nodes__, ((int32){0}));
	self->source__ = first_child__->source__;
	self->start__ = first_child__->start__;
...
string emit__1(Emitter__0 *_Nonnull const emitter__)
{
	...
	system__text__String_Builder__0 *_Nonnull const c_code__ = system__text__String_Builder__0__0new__with_capacity__1(allocate(sizeof(system__text__String_Builder__0)), total_size__);
...
system__text__String_Builder__0 *_Nonnull convert_type_name__2(Type__0 const *_Nonnull const type__, BOOL const include_type_parameters__)
{
	system__text__String_Builder__0 *_Nonnull const c_type__ = system__text__String_Builder__0__0new__0(allocate(sizeof(system__text__String_Builder__0)));
...
string convert_reference_type__3(BOOL const mutable_binding__, Type__0 const *_Nonnull type__, BOOL const nullable__)
{
	system__text__String_Builder__0 *_Nonnull const c_type__ = convert_type_name__1(type__);
...
string convert_type__3(BOOL const mutable_binding__, Type__0 const *_Nonnull type__, BOOL const optional__)
{
	...
	if (cond(bool_op(bool_arg(type__->is_primitive__) && bool_arg(string__0op__equal(unqualified_name__1(type__->name__), ((string){8,(uint8_t const*)"optional"}))))))
	{
		...
		{
			system__text__String_Builder__0 *_Nonnull const c_type__ = system__text__String_Builder__0__0new__1(allocate(sizeof(system__text__String_Builder__0)), ((string){10,(uint8_t const*)"optional__"}));
...
void convert_expression__2(Semantic_Node__0 const *_Nonnull const syntax__, Source_File_Builder__0 *_Nonnull const builder__)
{
	...
	{
		Semantic_Node__0 const *_Nonnull const child__ = system__collections__List__1__0op__element(syntax__->children__, ((int32){1}));
	...
	{
		Semantic_Node__0 const *_Nonnull child__ = system__collections__List__1__0op__element(syntax__->children__, ((int32){1}));
		int32 const operator__ = child__->kind__;
		child__ = system__collections__List__1__0op__element(syntax__->children__, ((int32){0}));
		Type__0 const *_Nonnull const type__ = child__->of_type__;
		if (cond(void_ptr__0op__not_equal(type__, none)))
		{
			write__2(builder__, convert_primitive_type_name__1(type__));
		}
	...
	{
		Semantic_Node__0 const *_Nonnull const child__ = system__collections__List__1__0op__element(syntax__->children__, ((int32){0}));
		Type__0 const *_Nonnull type__ = child__->of_type__;
		if (cond(void_ptr__0op__not_equal(type__, none)))
		{
...
void emit_member_declaration__4(Emitter__0 *_Nonnull const emitter__, Semantic_Node__0 const *_Nonnull const member__, string const class_name__, BOOL const is_value_type__)
{
	if (cond(int32__0op__equal(member__->kind__, ConstructorDeclaration__)))
	{
		...
		string return_type__ = string__0op__add(class_name__, ((string){4,(uint8_t const*)" mut"}));
...
void emit_default_constructor__3(Emitter__0 *_Nonnull const emitter__, string const type_name__, BOOL const is_value_type__)
{
	...
	string return_type__ = string__0op__add(type_name__, ((string){4,(uint8_t const*)" mut"}));
	if (cond(BOOL__0op__not(is_value_type__)))
	{
		return_type__ = string__0op__add(return_type__, ((string){8,(uint8_t const*)" ref mut"}));
	}
...
void emit_declaration__2(Emitter__0 *_Nonnull const emitter__, Semantic_Node__0 const *_Nonnull const declaration__)
{
	...
	else if (cond(int32__0op__equal(declaration__->kind__, FunctionDeclaration__)))
	{
		...
		string name__ = get_node_text__1(first_child__2(declaration__, Identifier__));
...
void emit_preamble__1(Emitter__0 *_Nonnull const emitter__)
{
	write_line__2(emitter__->type_declarations__, ((string){27,(uint8_t const*)"#include \"RuntimeLibrary.h\""}));
...
void add_symbol__3(Name_Table__0 *_Nonnull const name_table__, Name__0 const *_Nonnull const parent__, Symbol__0 const *_Nonnull const symbol__)
{
	Name__0 const *_Nonnull const name__ = add_symbol_name__3(name_table__, parent__, symbol__);
	for (void_ptr__0iter iter = system__collections__List__1__0iterate(symbol__->children__); void_ptr__0next(&iter);)
	{
		Symbol__0 const *_Nonnull const child__ = void_ptr__0current(&iter);
...
void add_syntax__3(Name_Table__0 *_Nonnull const name_table__, Name__0 const *_Nonnull const parent__, Syntax_Node__0 const *_Nonnull const syntax__)
{
	if (cond(bool_op(bool_arg(int32__0op__equal(syntax__->kind__, FunctionDeclaration__)) || bool_arg(int32__0op__equal(syntax__->kind__, MethodDeclaration__)))))
	{
		Name__0 const *_Nonnull const name__ = Name__0__0new__3(allocate(sizeof(Name__0)), parent__, FunctionName__, get_syntax_text__1(first_child_syntax__2(syntax__, Identifier__)));
	...
	else if (cond(int32__0op__equal(syntax__->kind__, ForStatement__)))
	{
		...
		Name__0 const *_Nonnull const name__ = Name__0__0new__3(allocate(sizeof(Name__0)), parent__, VariableName__, get_syntax_text__1(identifier__));
		Type__0 const *_Nullable const no_type__ = none;
		add_type_name__3(name_table__, name__, no_type__);
		add_syntax__3(name_table__, parent__, first_child_syntax__2(syntax__, Block__));
	}

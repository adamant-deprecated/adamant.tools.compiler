...
void main__1(system__console__Console__0 *_Nonnull const console__)
{
	...
	{
		console_write_line__2(console__, ((string){18,(uint8_t const*)"List length not 2!"}));
	}

	console_write_line__2(console__, string__0op__add(((string){11,(uint8_t const*)"strings[0]="}), Strings__0__0op__element(strings__, ((int32){0}))));
